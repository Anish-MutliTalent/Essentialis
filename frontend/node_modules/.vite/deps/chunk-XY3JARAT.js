...
async function getNFTFromRPC(options) {
  ...
  const [uri, owner] = await Promise.all([
    ...
    options.includeOwner ? import("./ownerOf-KXOC5WTC.js").then((m) => m.ownerOf({ contract: options.contract, tokenId })).catch(() => null) : null
  ]);
...
//# sourceMappingURL=chunk-XY3JARAT.js.map
