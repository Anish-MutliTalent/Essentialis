...
function WalletEntryButton(props) {
  ...
  return (0, import_jsx_runtime3.jsxs)(WalletButtonEl, { type: "button", onClick: selectWallet, "data-active": props.isActive, children: [iconOverride ? (0, import_jsx_runtime3.jsx)(Img, { client: props.client, src: iconOverride, alt: nameOverride, width: `${iconSize.xl}`, height: `${iconSize.xl}` }) : (0, import_jsx_runtime3.jsx)(WalletImage, { id: walletId, size: iconSize.xl, client: props.client }), (0, import_jsx_runtime3.jsxs)(Container, { flex: "column", gap: "xxs", expand: true, children: [nameOverride ? (0, import_jsx_runtime3.jsx)(Text, { color: "primaryText", weight: 600, children: nameOverride }) : (0, import_jsx_runtime3.jsx)(Skeleton, { width: "100px", height: fontSize.md }), props.badge ? (0, import_jsx_runtime3.jsx)(Text, { size: "sm", children: props.badge }) : isRecommended ? (0, import_jsx_runtime3.jsx)(Text, { size: "sm", children: props.connectLocale.recommended }) : isInstalled ? (0, import_jsx_runtime3.jsx)(Text, { size: "sm", children: props.connectLocale.installed }) : null] })] });
}
...
//# sourceMappingURL=chunk-P3HMA5O5.js.map
