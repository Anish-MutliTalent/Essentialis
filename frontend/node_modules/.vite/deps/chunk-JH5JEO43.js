...
function useWalletImage(id) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-YPIYZL6V.js");
...
var WalletProviderContext = (0, import_react10.createContext)(void 0);
function WalletProvider(props) {
  return (0, import_jsx_runtime7.jsx)(WalletProviderContext.Provider, { value: props, children: props.children });
}
function useWalletContext() {
  const ctx = (0, import_react10.useContext)(WalletProviderContext);
  if (!ctx) {
...
var Skeleton = (props) => {
  return (0, import_jsx_runtime8.jsx)(SkeletonDiv, { color: props.color, style: {
    height: props.height,
...
var Img = (props) => {
  ...
  if (propSrc === void 0) {
    return (0, import_jsx_runtime14.jsx)(Skeleton, { width: widthPx, height: heightPx });
  }
  const getSrc = () => {
    try {
  ...
  return (0, import_jsx_runtime14.jsxs)("div", { style: {
    ...
    alignItems: "center",
    justifyItems: "center"
  }, children: [!isLoaded && (0, import_jsx_runtime14.jsx)(Skeleton, { width: widthPx, height: heightPx }), (0, import_jsx_runtime14.jsx)("img", { onLoad: () => {
    setIsLoaded(true);
...
function WalletImage(props) {
  const theme = useCustomTheme();
  const [image, setImage] = (0, import_react13.useState)(void 0);
  ...
  if ((image == null ? void 0 : image.authProvider) === "email") {
    return (0, import_jsx_runtime15.jsx)(EmailIcon, { size: props.size, color: theme.colors.accentText });
  }
  if ((image == null ? void 0 : image.authProvider) === "phone") {
    return (0, import_jsx_runtime15.jsx)(PhoneIcon, { size: props.size, color: theme.colors.accentText });
  }
  if ((image == null ? void 0 : image.authProvider) === "passkey") {
    return (0, import_jsx_runtime15.jsx)(FingerPrintIcon, { size: props.size, color: theme.colors.accentText });
  }
  if ((image == null ? void 0 : image.authProvider) === "wallet") {
    return (0, import_jsx_runtime15.jsx)(OutlineWalletIcon, { size: props.size, color: theme.colors.accentText });
  }
  if ((image == null ? void 0 : image.authProvider) === "guest") {
    return (0, import_jsx_runtime15.jsx)(GuestIcon, { size: props.size, color: theme.colors.accentText });
  }
  if (image == null ? void 0 : image.uri) {
    return (0, import_jsx_runtime15.jsx)(Img, { src: image.uri, width: props.size, height: props.size, loading: "eager", client: props.client, style: {
      borderRadius: radius.md,
      ...props.style
    } });
  }
  return (0, import_jsx_runtime15.jsx)(WalletImageQuery, { id: props.id, size: props.size, client: props.client });
}
function WalletImageQuery(props) {
  const walletImage = useWalletImage(props.id);
  if (walletImage.isFetched && !walletImage.data) {
    return (0, import_jsx_runtime15.jsx)(Img, { client: props.client, src: genericWalletIcon, width: props.size, height: props.size });
  }
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JH5JEO43.js.map
