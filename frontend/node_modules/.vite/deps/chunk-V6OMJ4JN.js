...
async function getOwnedTokens(args) {
  ...
  const [{ getV1TokensErc20ByOwnerAddress }, { getThirdwebDomains }, { getClientFetch }, { assertInsightEnabled }, { stringify }] = await Promise.all([
    import("./thirdweb-M3WKWZPO.js"),
    import("./domains-DNNNQ5NM.js"),
    import("./fetch-SPJCECU5.js"),
    import("./common-IQBEUTWT.js"),
...
async function transformOwnedToken(token) {
  const { toTokens } = await import("./units-QBOMNCVL.js");
  return token.map((t) => {
...
//# sourceMappingURL=chunk-V6OMJ4JN.js.map
