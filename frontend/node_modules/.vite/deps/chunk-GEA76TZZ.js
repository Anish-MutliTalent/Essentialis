...
} from "./chunk-LCFGTMVC.js";
import {
  $s
} from "./chunk-WHKSU3WO.js";
import {
  DEFAULT_PROJECT_ID
...
async function createWalletConnectClient(options) {
  ...
  walletConnectClient.on("session_proposal", async (event) => {
    const { onSessionProposal } = await import("./session-proposal-RKFGZJQV.js");
  ...
  walletConnectClient.on("session_request", async (event) => {
    const { fulfillRequest } = await import("./session-request-ODB6RUUY.js");
...
//# sourceMappingURL=chunk-GEA76TZZ.js.map
