...
var y = (e, t) => {
  for (var a in t) x(e, a, { get: t[a], enumerable: true });
};
var C = {};
y(C, { authenticate: () => H, isAutocompleteAvailable: () => E, isAvailable: () => L, isLocalAuthenticator: () => v, register: () => k });
var s = {};
y(s, { bufferToHex: () => D, concatenateBuffers: () => O, isBase64url: () => A, parseBase64url: () => o, parseBuffer: () => K, sha256: () => p, toBase64url: () => n, toBuffer: () => b });
function b(e) {
...
async function k(e) {
  ...
  return { type: i.type, id: i.id, rawId: n(i.rawId), authenticatorAttachment: i.authenticatorAttachment, clientExtensionResults: i.getClientExtensionResults(), response: { attestationObject: n(r.attestationObject), authenticatorData: n(r.getAuthenticatorData()), clientDataJSON: n(r.clientDataJSON), publicKey: n(c), publicKeyAlgorithm: r.getPublicKeyAlgorithm(), transports: r.getTransports() }, user: t };
}
async function E() {
...
function N(e, t) {
  let a = t.aaguid;
  return { authenticator: { aaguid: a, counter: t.signCount, icon_light: "https://webauthn.passwordless.id/authenticators/" + a + "-light.png", icon_dark: "https://webauthn.passwordless.id/authenticators/" + a + "-dark.png", name: g[a] ?? "Unknown" }, credential: { id: e.id, publicKey: e.response.publicKey, algorithm: B(e.response.publicKeyAlgorithm), transports: e.response.transports }, synced: t.flags.backupEligibility, user: e.user, userVerified: t.flags.userVerified };
}
function I(e, t) {
...
async function R(e, t) {
  let a = T(e), i = o(t);
  return crypto.subtle.importKey("spki", i, a, false, ["verify"]);
}
...
//# sourceMappingURL=chunk-GFRQZC2Q.js.map
