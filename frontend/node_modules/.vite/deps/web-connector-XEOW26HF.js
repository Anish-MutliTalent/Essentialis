  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        gas: hexlify(tx.gas),
        nonce: hexlify(tx.nonce) || toHex(await import("./eth_getTransactionCount-TPHW4AKL.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-E3M37OXA.js");
...
//# sourceMappingURL=web-connector-XEOW26HF.js.map
