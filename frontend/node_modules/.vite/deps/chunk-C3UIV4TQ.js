...
async function isOpStackChain(chain) {
  ...
  try {
    const { getChainMetadata } = await import("./utils-CQJVOB7D.js");
...
async function estimateGasCost(options) {
  ...
  if (await isOpStackChain(transaction.chain)) {
    const { estimateL1Fee } = await import("./estimate-l1-fee-FFEF4PCK.js");
...
//# sourceMappingURL=chunk-C3UIV4TQ.js.map
