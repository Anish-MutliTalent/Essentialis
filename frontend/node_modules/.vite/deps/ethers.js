...
try {
  ...
  const logger20 = new Logger(version3);
  WS = function() {
    logger20.throwError("WebSockets not supported in this environment", Logger.errors.UNSUPPORTED_OPERATION, {
