...
} from "./chunk-WBGY257L.js";
import {
  WalletLogoSpinner
} from "./chunk-PNQZFOXA.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
} from "./chunk-OM6R7FF7.js";
import {
  Input,
  Label,
  Spinner,
...
import {
  getCurrencyMetadata
} from "./chunk-NAMX4NLN.js";
import {
  decimals
} from "./chunk-CZNO3JDW.js";
import {
  isInAppWallet
} from "./chunk-AW5PI6X3.js";
import {
  socialAuthOptions
} from "./chunk-AKEHYN4S.js";
import {
  isInsightEnabled
} from "./chunk-KQSYSAB7.js";
import {
  resolveArweaveScheme
} from "./chunk-FTGVVEWF.js";
import {
  polygon
} from "./chunk-3C5462XG.js";
import {
  ethereum
} from "./chunk-H3ZSLUUG.js";
import {
  autoConnectCore,
  hasSmartAccount
...
import {
  approve,
  isSmartWallet
} from "./chunk-47A7GAXO.js";
import {
  allowance
} from "./chunk-MTDFNONV.js";
import {
  once
} from "./chunk-NACC2RRT.js";
import {
  track
} from "./chunk-CKBH74JP.js";
import {
  ClientScopedStorage
...
import {
  require_jsx_runtime
} from "./chunk-633M6DZL.js";
import {
  require_react_dom
} from "./chunk-WYJWZ5XA.js";
import {
  require_react
} from "./chunk-6ZGMNFQ2.js";
import {
  __toESM
...
function TokenSymbol(props) {
  if (!isNativeToken(props.token)) {
    return (0, import_jsx_runtime2.jsx)(Text, { size: props.size, color: props.color || "primaryText", inline: props.inline, children: props.token.symbol });
  }
  return (0, import_jsx_runtime2.jsx)(NativeTokenSymbol, { chain: props.chain, size: props.size, color: props.color, inline: props.inline });
}
function NativeTokenSymbol(props) {
  const chainSymbolQuery = useChainSymbol(props.chain);
  if (chainSymbolQuery.isLoading) {
    return (0, import_jsx_runtime2.jsx)(Skeleton, { width: "70px", height: fontSize[props.size] });
  }
  return (0, import_jsx_runtime2.jsx)(Text, { size: props.size, color: props.color || "primaryText", inline: props.inline, children: chainSymbolQuery.symbol ?? "ETH" });
}
  ...
  const loginMutation = useMutation({
    ...
    mutationFn: async () => {
      ...
      const [payload, { signLoginPayload }] = await Promise.all([
        ...
        import("./sign-login-payload-ZZDHUL5E.js")
      ]);
      if (payload.chain_id) {
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbase-web-RGDHM2SW.js");
...
var CopyIcon2 = (props) => {
  ...
  }, children: (0, import_jsx_runtime19.jsx)(ToolTip, { tip: props.tip, side: props.side, align: props.align, children: (0, import_jsx_runtime19.jsx)("div", { children: (0, import_jsx_runtime19.jsx)(Container, { color: showCheckIcon ? "success" : void 0, flex: "row", center: "both", children: showCheckIcon ? (0, import_jsx_runtime19.jsx)(CheckIcon, { className: "tw-check-icon" }) : (0, import_jsx_runtime19.jsx)(CopyIcon, { className: "tw-copy-icon" }) }) }) }) });
};
...
async function getConnectLocale(localeId) {
  switch (localeId) {
    case "es_ES": {
      return (await import("./es-IQ6FAY2Q.js")).default;
    }
    case "ja_JP": {
      return (await import("./ja-T24SOJVD.js")).default;
    }
    case "tl_PH": {
      return (await import("./tl-7NEI3NEJ.js")).default;
    }
    case "vi_VN": {
      return (await import("./vi-RCBH5RFP.js")).default;
    }
    case "de_DE": {
      return (await import("./de-D7UP5ZHM.js")).default;
    }
    case "ko_KR": {
      return (await import("./kr-UPE233MN.js")).default;
    }
    case "fr_FR": {
      return (await import("./fr-3ZMYRKKM.js")).default;
    }
    case "ru_RU": {
      return (await import("./ru-36S2RS3T.js")).default;
    }
    case "pt_BR": {
      return (await import("./br-H74O7WAL.js")).default;
    }
    default: {
      return (await import("./en-UHK5KYVR.js")).default;
    }
  }
}
...
function NetworkSelectorContent(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(Container, { children: [(0, import_jsx_runtime30.jsx)(Container, { p: "lg", children: props.onBack ? (0, import_jsx_runtime30.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }) : (0, import_jsx_runtime30.jsx)(ModalTitle, { children: locale.title }) }), props.showTabs !== false && (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [(0, import_jsx_runtime30.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime30.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime30.jsx)(TabButton, { onClick: () => setSelectedTab("all"), "data-active": selectedTab === "all", children: locale.allNetworks }), (0, import_jsx_runtime30.jsx)(TabButton, { onClick: () => setSelectedTab("mainnet"), "data-active": selectedTab === "mainnet", children: locale.mainnets }), (0, import_jsx_runtime30.jsx)(TabButton, { onClick: () => setSelectedTab("testnet"), "data-active": selectedTab === "testnet", children: locale.testnets })] }) }), (0, import_jsx_runtime30.jsx)(Spacer, { y: "lg" })] }), props.showTabs === false && (0, import_jsx_runtime30.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime30.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime30.jsxs)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: [(0, import_jsx_runtime30.jsx)(StyledMagnifyingGlassIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime30.jsx)(Input, { style: {
    padding: `${spacing.sm} ${spacing.md} ${spacing.sm} ${spacing.xxl}`
  }, tabIndex: -1, variant: "outline", value: searchTerm, onChange: (e) => {
    setSearchTerm(e.target.value);
  }, disabled: isAllChainsQueryLoading, placeholder: isAllChainsQueryLoading ? "Loading chains..." : locale.inputPlaceholder }), (deferredSearchTerm !== searchTerm || isAllChainsQueryLoading) && (0, import_jsx_runtime30.jsx)("div", { style: {
    position: "absolute",
    right: spacing.md
  }, children: (0, import_jsx_runtime30.jsx)(Spinner, { size: "md", color: "accentText" }) })] }) }), (0, import_jsx_runtime30.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime30.jsx)(Container, { px: "md", children: (0, import_jsx_runtime30.jsx)(NetworkTabContent, { chainSections: filteredChainSections, onSwitch: handleSwitch, renderChain: (_d = props.networkSelector) == null ? void 0 : _d.renderChain, connectLocale: props.connectLocale, client: props.client, close: props.closeModal }) }), onCustomClick && (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [(0, import_jsx_runtime30.jsx)(Line, {}), (0, import_jsx_runtime30.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime30.jsx)(Button, { fullWidth: true, variant: "link", onClick: () => {
    onCustomClick();
    props.closeModal();
  }, style: {
    display: "flex",
...
var NetworkTabContent = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(Container, { scrollY: true, animate: "fadein", style: {
    height: "330px",
    paddingBottom: spacing.lg
  }, children: noChainsToShow ? (0, import_jsx_runtime30.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", children: [(0, import_jsx_runtime30.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime30.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime30.jsx)(Text, { children: " No Results " })] }) : chainSections.map((section, idx) => {
    if (section.chains.length === 0) {
      return null;
    }
    return (0, import_jsx_runtime30.jsxs)(import_react19.Fragment, { children: [idx !== 0 && (0, import_jsx_runtime30.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime30.jsx)(SectionLabel, { children: section.label }), (0, import_jsx_runtime30.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime30.jsx)(NetworkList, { chains: section.chains, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close, client: props.client, connectLocale: props.connectLocale })] }, section.label);
  }) });
};
var NetworkList = (0, import_react19.memo)(function NetworkList2(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(NetworkListUl, { children: chainsToShow.map((chain, i) => {
    if (!chain) {
      return null;
    }
    ...
    return (0, import_jsx_runtime30.jsx)("li", { ref: isLast ? lastItemRef : void 0, children: RenderChain ? (0, import_jsx_runtime30.jsx)(RenderChain, { switchChain: () => {
      handleSwitch(chain);
    }, chain, switching: switchingChainId === chain.id, switchFailed: errorSwitchingChainId === chain.id, close: props.close }) : (0, import_jsx_runtime30.jsx)(ChainButton, { chain, confirming, onClick: () => handleSwitch(chain), switchingFailed, client: props.client, connectLocale: props.connectLocale }) }, chain.id);
  }) });
});
var ChainButton = (0, import_react19.memo)(function ChainButton2(props) {
  ...
  const activeChain = useActiveWalletChain();
  return (0, import_jsx_runtime30.jsx)(ChainProvider, { chain, children: (0, import_jsx_runtime30.jsxs)(NetworkButton, { "data-active": (activeChain == null ? void 0 : activeChain.id) === chain.id, onClick: props.onClick, children: [(0, import_jsx_runtime30.jsxs)(Container, { style: {
    position: "relative",
    display: "flex",
    flexShrink: 0,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime30.jsx)(ChainIcon, { client: props.client, loadingComponent: (0, import_jsx_runtime30.jsx)(Skeleton, { width: `${iconSize.lg}px`, height: `${iconSize.lg}px` }), fallbackComponent: (0, import_jsx_runtime30.jsx)("img", { src: fallbackChainIcon, alt: "", style: {
    width: `${iconSize.lg}px`,
    height: `${iconSize.lg}px`
  } }), style: {
    width: `${iconSize.lg}px`,
    height: `${iconSize.lg}px`
  }, loading: "lazy" }), (activeChain == null ? void 0 : activeChain.id) === chain.id && (0, import_jsx_runtime30.jsx)(ChainActiveDot, { className: "tw-chain-active-dot-button-network-selector" })] }), confirming || switchingFailed ? (0, import_jsx_runtime30.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: spacing.xs
  }, children: [(0, import_jsx_runtime30.jsx)(ChainName2, { loadingComponent: (0, import_jsx_runtime30.jsx)(Skeleton, { width: "150px", height: "20px" }) }), (0, import_jsx_runtime30.jsxs)(Container, { animate: "fadein", flex: "row", gap: "xxs", center: "y", children: [confirming && (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [(0, import_jsx_runtime30.jsx)(Text, { size: "xs", color: "accentText", children: locale.switchingNetwork }), (0, import_jsx_runtime30.jsx)(Spinner, { size: "xs", color: "accentText" })] }), switchingFailed && (0, import_jsx_runtime30.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime30.jsx)(Text, { size: "xs", color: "danger", children: locale.networkSelector.failedToSwitch }) })] })] }) : (0, import_jsx_runtime30.jsx)(ChainName2, { loadingComponent: (0, import_jsx_runtime30.jsx)(Skeleton, { width: "150px", height: "20px" }), className: "tw-chain-icon-none-confirming" })] }) });
});
...
function useNetworkSwitcherModal() {
  ...
  const openNetworkSwitcher = (0, import_react19.useCallback)(async (props) => {
    ...
    setRootEl((0, import_jsx_runtime30.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime30.jsx)(Modal, { size: "compact", open: true, setOpen: (value) => {
      if (!value) {
        closeModal();
      }
    }, style: {
      paddingBottom: props.onCustomClick ? spacing.md : "0px"
    }, children: (0, import_jsx_runtime30.jsx)(NetworkSelectorContent, { client: props.client, closeModal, chains: [activeChain], connectLocale: locale, networkSelector: {
...
function Tabs({ selected, onSelect, options, children }) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime31.jsxs)("div", { children: [(0, import_jsx_runtime31.jsx)(Container, { flex: "row", center: "y", style: { width: "100%", borderRadius: radius.lg }, p: "xxs", bg: "secondaryButtonBg", children: options.map((option) => (0, import_jsx_runtime31.jsx)(Button, { variant: "accent", type: "button", onClick: () => onSelect(option.value), style: {
    flex: 1,
  ...
  }, children: (0, import_jsx_runtime31.jsx)(Text, { color: option.value === selected ? "primaryText" : "secondaryText", style: { textAlign: "center" }, size: "sm", children: option.label }) }, option.value)) }), (0, import_jsx_runtime31.jsx)(Spacer, { y: "sm" }), children] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/CoinsIcon.js
var import_jsx_runtime32 = __toESM(require_jsx_runtime(), 1);
var CoinsIcon = (props) => {
  return (0, import_jsx_runtime32.jsxs)("svg", { width: props.size, height: props.size, role: "presentation", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime32.jsx)("path", { d: "M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime32.jsx)("path", { d: "M18.0901 10.37C19.0354 10.7224 19.8766 11.3075 20.5358 12.0712C21.1951 12.8349 21.6512 13.7524 21.8618 14.7391C22.0725 15.7257 22.031 16.7495 21.7411 17.7158C21.4513 18.6822 20.9224 19.5598 20.2035 20.2676C19.4846 20.9754 18.5988 21.4905 17.6281 21.7652C16.6573 22.04 15.633 22.0655 14.6498 21.8395C13.6666 21.6134 12.7562 21.1431 12.0029 20.472C11.2496 19.8009 10.6777 18.9507 10.3401 18", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime32.jsx)("path", { d: "M7 6H8V10", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime32.jsx)("path", { d: "M16.7101 13.88L17.4101 14.59L14.5901 17.41", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/FundsIcon.js
var import_jsx_runtime33 = __toESM(require_jsx_runtime(), 1);
var FundsIcon = ({ size: size4 }) => {
  return (0, import_jsx_runtime33.jsxs)("svg", { width: size4, height: size4, viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: [(0, import_jsx_runtime33.jsx)("path", { d: "M14.001 8.00048C14.001 9.18726 13.649 10.3474 12.9897 11.3342C12.3304 12.3209 11.3932 13.09 10.2968 13.5442C9.20032 13.9984 7.99382 14.1172 6.82984 13.8857C5.66587 13.6541 4.59668 13.0826 3.7575 12.2435C2.91832 11.4043 2.34683 10.3351 2.1153 9.17111C1.88377 8.00713 2.0026 6.80064 2.45676 5.70419C2.91092 4.60775 3.68002 3.6706 4.66679 3.01126C5.65357 2.35192 6.8137 2 8.00048 2", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime33.jsx)("path", { d: "M14.0005 2L8 8.00048", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime33.jsx)("path", { d: "M10.3984 2H13.9987V5.60029", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function TokenIcon(props) {
  ...
  return tokenImage ? (0, import_jsx_runtime34.jsx)(Img, { src: tokenImage, width: iconSize[props.size], height: iconSize[props.size], fallbackImage: genericTokenIcon, client: props.client }) : (0, import_jsx_runtime34.jsx)(Container, { center: "both", style: { width: iconSize[props.size], height: iconSize[props.size] }, color: "secondaryText", children: (0, import_jsx_runtime34.jsx)(CoinsIcon, { size: iconSize[props.size] }) });
}
...
async function fetchBuySupportedDestinations(client, isTestMode) {
  return withCache(async () => {
    ...
    if (!data.result) {
      throw new Error(`Failed to parse supported destinations: ${data ? stringify(data) : void 0}`);
    }
...
function PayTokenIcon(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(TokenIcon, { token: isNativeToken(token) ? { nativeToken: true } : {
...
function BuyTxHistoryButton(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime36.jsxs)(Container, { flex: "row", center: "y", gap: "sm", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime36.jsx)(PayTokenIcon, { client: props.client, chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
    address: props.txInfo.status.quote.toToken.tokenAddress
  } }), (0, import_jsx_runtime36.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime36.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime36.jsxs)(Text, { size: "sm", color: "primaryText", children: ["Buy", " ", formatNumber(Number(props.txInfo.type === "swap" ? props.txInfo.status.quote.toAmount : props.txInfo.status.quote.estimatedToTokenAmount), 6), " ", props.txInfo.status.quote.toToken.symbol] }) }), (0, import_jsx_runtime36.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime36.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime36.jsx)(ChainName, { chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime36.jsx)(Container, { flex: "row", gap: "xxs", center: "y", children: (0, import_jsx_runtime36.jsx)(Text, { size: "xs", color: statusMeta.color, children: statusMeta.status }) })] });
}
...
function useBuyTransactionsToShow(client) {
  ...
  const [pageIndex, setPageIndex] = (0, import_react21.useState)(0);
  const txStatusList = [];
  const PAGE_SIZE = 10;
  ...
  const pendingTxStoreValue = (0, import_react21.useSyncExternalStore)(pendingTransactions.subscribe, pendingTransactions.getValue);
...
function PayTxHistoryList(props) {
  ...
  return (0, import_jsx_runtime37.jsxs)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    width: "100%",
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime37.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [noTransactions && !isLoading && (0, import_jsx_runtime37.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime37.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime37.jsx)(Text, { children: "No Transactions" })] }), noTransactions && isLoading && (0, import_jsx_runtime37.jsx)(Container, { flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime37.jsx)(Spinner, { size: "xl", color: "accentText" }) }), txInfosToShow.length > 0 && (0, import_jsx_runtime37.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
    var _a;
    return (0, import_jsx_runtime37.jsx)(BuyTxHistoryButton, { txInfo, client: props.client, onClick: () => {
      props.onSelectTx(txInfo);
    } }, txInfo.type === "swap" ? (_a = txInfo.status.source) == null ? void 0 : _a.transactionHash : txInfo.status.intentId);
  }) }), isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [(0, import_jsx_runtime37.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime37.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime37.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] })] }), pagination && !hidePagination && (0, import_jsx_runtime37.jsx)(Container, { py: "md", children: (0, import_jsx_runtime37.jsxs)("div", { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: spacing.sm
  }, children: [(0, import_jsx_runtime37.jsxs)(Button, { variant: "outline", gap: "xs", disabled: pageIndex === 0, "data-disabled": pageIndex === 0, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev - 1);
  }, children: [(0, import_jsx_runtime37.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "rotate(180deg)"
  } }), "Prev"] }), (0, import_jsx_runtime37.jsxs)(Button, { variant: "outline", gap: "xs", disabled: !pagination.hasNextPage, "data-disabled": !pagination.hasNextPage, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev + 1);
  }, children: ["Next", (0, import_jsx_runtime37.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] }) })] });
}
...
function TokenInfoRow(props) {
  ...
  return (0, import_jsx_runtime38.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime38.jsx)(Text, { size: "sm", children: props.label }), (0, import_jsx_runtime38.jsxs)(Container, { flex: "column", gap: "3xs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime38.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime38.jsx)(PayTokenIcon, { chain: chainObj, size: "sm", token: {
    address: props.tokenAddress
  }, client: props.client }), (0, import_jsx_runtime38.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(props.tokenAmount), 6), " ", props.tokenSymbol] })] }), (0, import_jsx_runtime38.jsx)(Text, { size: "xs", children: name })] })] });
}
...
var CADIcon = (props) => {
  return (0, import_jsx_runtime39.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime39.jsx)("mask", { id: "a", children: (0, import_jsx_runtime39.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime39.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime39.jsx)("path", { fill: "#d80027", d: "M0 0v512h144l112-64 112 64h144V0H368L256 64 144 0Z" }), (0, import_jsx_runtime39.jsx)("path", { fill: "#eee", d: "M144 0h224v512H144Z" }), (0, import_jsx_runtime39.jsx)("path", { fill: "#d80027", d: "m301 289 44-22-22-11v-22l-45 22 23-44h-23l-22-34-22 33h-23l23 45-45-22v22l-22 11 45 22-12 23h45v33h22v-33h45z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/EURIcon.js
var import_jsx_runtime40 = __toESM(require_jsx_runtime(), 1);
var EURIcon = (props) => {
  return (0, import_jsx_runtime40.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime40.jsx)("mask", { id: "a", children: (0, import_jsx_runtime40.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime40.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime40.jsx)("path", { fill: "#0052b4", d: "M0 0h512v512H0z" }), (0, import_jsx_runtime40.jsx)("path", { fill: "#ffda44", d: "m256 100.2 8.3 25.5H291l-21.7 15.7 8.3 25.6-21.7-15.8-21.7 15.8 8.3-25.6-21.7-15.7h26.8zm-110.2 45.6 24 12.2 18.9-19-4.2 26.5 23.9 12.2-26.5 4.2-4.2 26.5-12.2-24-26.5 4.3 19-19zM100.2 256l25.5-8.3V221l15.7 21.7 25.6-8.3-15.8 21.7 15.8 21.7-25.6-8.3-15.7 21.7v-26.8zm45.6 110.2 12.2-24-19-18.9 26.5 4.2 12.2-23.9 4.2 26.5 26.5 4.2-24 12.2 4.3 26.5-19-19zM256 411.8l-8.3-25.5H221l21.7-15.7-8.3-25.6 21.7 15.8 21.7-15.8-8.3 25.6 21.7 15.7h-26.8zm110.2-45.6-24-12.2-18.9 19 4.2-26.5-23.9-12.2 26.5-4.2 4.2-26.5 12.2 24 26.5-4.3-19 19zM411.8 256l-25.5 8.3V291l-15.7-21.7-25.6 8.3 15.8-21.7-15.8-21.7 25.6 8.3 15.7-21.7v26.8zm-45.6-110.2-12.2 24 19 18.9-26.5-4.2-12.2 23.9-4.2-26.5-26.5-4.2 24-12.2-4.3-26.5 19 19z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/GBPIcon.js
var import_jsx_runtime41 = __toESM(require_jsx_runtime(), 1);
var GBPIcon = (props) => {
  return (0, import_jsx_runtime41.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", id: "Layer_1", x: "0px", y: "0px", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime41.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime41.jsxs)("g", { children: [(0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M52.92,100.142c-20.109,26.163-35.272,56.318-44.101,89.077h133.178L52.92,100.142z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M503.181,189.219c-8.829-32.758-23.993-62.913-44.101-89.076l-89.075,89.076H503.181z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M8.819,322.784c8.83,32.758,23.993,62.913,44.101,89.075l89.074-89.075L8.819,322.784L8.819,322.784   z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M411.858,52.921c-26.163-20.109-56.317-35.272-89.076-44.102v133.177L411.858,52.921z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M100.142,459.079c26.163,20.109,56.318,35.272,89.076,44.102V370.005L100.142,459.079z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M189.217,8.819c-32.758,8.83-62.913,23.993-89.075,44.101l89.075,89.075V8.819z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M322.783,503.181c32.758-8.83,62.913-23.993,89.075-44.101l-89.075-89.075V503.181z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#0052B4", d: "M370.005,322.784l89.075,89.076c20.108-26.162,35.272-56.318,44.101-89.076H370.005z" })] }), (0, import_jsx_runtime41.jsxs)("g", { children: [(0, import_jsx_runtime41.jsx)("path", { fill: "#D80027", d: "M509.833,222.609h-220.44h-0.001V2.167C278.461,0.744,267.317,0,256,0   c-11.319,0-22.461,0.744-33.391,2.167v220.44v0.001H2.167C0.744,233.539,0,244.683,0,256c0,11.319,0.744,22.461,2.167,33.391   h220.44h0.001v220.442C233.539,511.256,244.681,512,256,512c11.317,0,22.461-0.743,33.391-2.167v-220.44v-0.001h220.442   C511.256,278.461,512,267.319,512,256C512,244.683,511.256,233.539,509.833,222.609z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#D80027", d: "M322.783,322.784L322.783,322.784L437.019,437.02c5.254-5.252,10.266-10.743,15.048-16.435   l-97.802-97.802h-31.482V322.784z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#D80027", d: "M189.217,322.784h-0.002L74.98,437.019c5.252,5.254,10.743,10.266,16.435,15.048l97.802-97.804   V322.784z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#D80027", d: "M189.217,189.219v-0.002L74.981,74.98c-5.254,5.252-10.266,10.743-15.048,16.435l97.803,97.803   H189.217z" }), (0, import_jsx_runtime41.jsx)("path", { fill: "#D80027", d: "M322.783,189.219L322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.047   l-97.802,97.803V189.219z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/JPYIcon.js
var import_jsx_runtime42 = __toESM(require_jsx_runtime(), 1);
var JPYIcon = (props) => {
  return (0, import_jsx_runtime42.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime42.jsxs)("g", { fill: "none", fillRule: "evenodd", children: [(0, import_jsx_runtime42.jsx)("circle", { cx: "16", cy: "16", fill: "#a81b1b", r: "16" }), (0, import_jsx_runtime42.jsx)("path", { d: "M17.548 18.711v1.878h5.063v2.288h-5.063V25.5h-3.096v-2.623H9.389v-2.288h5.063v-1.878H9.389v-2.288h4.171L7.5 7.5h3.752l4.8 7.534L20.853 7.5H24.5l-6.086 8.923h4.197v2.288z", fill: "#ffffff" })] }) });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/USDIcon.js
var import_jsx_runtime43 = __toESM(require_jsx_runtime(), 1);
var USDIcon = (props) => {
  return (0, import_jsx_runtime43.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: props.size, height: props.size, x: "0px", y: "0px", viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime43.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime43.jsxs)("g", { children: [(0, import_jsx_runtime43.jsx)("path", { fill: "#D80027", d: "M244.87,256H512c0-23.106-3.08-45.49-8.819-66.783H244.87V256z" }), (0, import_jsx_runtime43.jsx)("path", { fill: "#D80027", d: "M244.87,122.435h229.556c-15.671-25.572-35.708-48.175-59.07-66.783H244.87V122.435z" }), (0, import_jsx_runtime43.jsx)("path", { fill: "#D80027", d: "M256,512c60.249,0,115.626-20.824,159.356-55.652H96.644C140.374,491.176,195.751,512,256,512z" }), (0, import_jsx_runtime43.jsx)("path", { fill: "#D80027", d: "M37.574,389.565h436.852c12.581-20.529,22.338-42.969,28.755-66.783H8.819   C15.236,346.596,24.993,369.036,37.574,389.565z" })] }), (0, import_jsx_runtime43.jsx)("path", { fill: "#0052B4", d: "M118.584,39.978h23.329l-21.7,15.765l8.289,25.509l-21.699-15.765L85.104,81.252l7.16-22.037  C73.158,75.13,56.412,93.776,42.612,114.552h7.475l-13.813,10.035c-2.152,3.59-4.216,7.237-6.194,10.938l6.596,20.301l-12.306-8.941  c-3.059,6.481-5.857,13.108-8.372,19.873l7.267,22.368h26.822l-21.7,15.765l8.289,25.509l-21.699-15.765l-12.998,9.444  C0.678,234.537,0,245.189,0,256h256c0-141.384,0-158.052,0-256C205.428,0,158.285,14.67,118.584,39.978z M128.502,230.4  l-21.699-15.765L85.104,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822l-21.7,15.765L128.502,230.4z   M120.213,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  L120.213,130.317z M220.328,230.4l-21.699-15.765L176.93,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  l-21.7,15.765L220.328,230.4z M212.039,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822  l8.288-25.509l8.288,25.509h26.822L212.039,130.317z M212.039,55.743l8.289,25.509l-21.699-15.765L176.93,81.252l8.289-25.509  l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822L212.039,55.743z" })] });
};
...
function getFiatIcon(currency, size4) {
  return currency.icon ? (0, import_jsx_runtime44.jsx)(currency.icon, { size: iconSize[size4] }) : (0, import_jsx_runtime44.jsx)("img", { src: `https://flagsapi.com/${currency.countryCode.toUpperCase()}/flat/64.png`, alt: currency.shorthand, width: iconSize[size4], height: iconSize[size4] });
}
var UnknownCurrencyIcon = (props) => {
  return (0, import_jsx_runtime44.jsx)(RadiobuttonIcon, { width: props.size, height: props.size });
};
...
function OnRampTxDetailsTable(props) {
  ...
  return (0, import_jsx_runtime45.jsxs)("div", { children: [(0, import_jsx_runtime45.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime45.jsx)(Text, { size: "sm", children: "Pay" }), (0, import_jsx_runtime45.jsx)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: (0, import_jsx_runtime45.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [getFiatIcon(currencyMeta, "sm"), (0, import_jsx_runtime45.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.fiat.amount), 2), " ", props.fiat.currencySymbol] })] }) })] }), lineSpacer, (0, import_jsx_runtime45.jsx)(TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), props.statusMeta && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [lineSpacer, (0, import_jsx_runtime45.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime45.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime45.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime45.jsx)(Text, { color: props.statusMeta.color, children: props.statusMeta.text }) })] })] }), lineSpacer, onrampTxHash && ((_c = (_b = onRampExplorers.explorers) == null ? void 0 : _b[0]) == null ? void 0 : _c.url) && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime45.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl((_d = onRampExplorers.explorers[0]) == null ? void 0 : _d.url, onrampTxHash), target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm
  }, children: ["View on Explorer", (0, import_jsx_runtime45.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function StepIcon(props) {
  return (0, import_jsx_runtime46.jsx)(Container, { flex: "row", center: "both", color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: (0, import_jsx_runtime46.jsx)(Circle, { children: props.isDone ? (0, import_jsx_runtime46.jsx)(CheckIcon, { width: iconSize.sm, height: iconSize.sm }) : (0, import_jsx_runtime46.jsx)(PulsingDot, { "data-active": props.isActive }) }) });
}
function Step(props) {
  return (0, import_jsx_runtime46.jsxs)(Container, { flex: "row", center: "y", gap: "xs", style: {
    fontSize: fontSize.sm
  }, color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: [(0, import_jsx_runtime46.jsx)(StepIcon, { isDone: props.isDone, isActive: props.isActive }), props.label] });
}
...
function FiatSteps(props) {
  ...
  const onRampTokenInfo = (0, import_jsx_runtime47.jsx)("div", { children: (0, import_jsx_runtime47.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(onRampTokenAmount), 6), " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) });
  const fiatIcon = getFiatIcon(currency, "sm");
  const onRampTokenIcon = (0, import_jsx_runtime47.jsx)(PayTokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client });
  const toTokenIcon = (0, import_jsx_runtime47.jsx)(PayTokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client });
  const onRampChainInfo = (0, import_jsx_runtime47.jsx)(Text, { size: "xs", children: onRampName.name });
  const partialSuccessToTokenInfo = ((_a = props.status) == null ? void 0 : _a.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination ? (0, import_jsx_runtime47.jsxs)("div", { children: [(0, import_jsx_runtime47.jsxs)(Text, { color: "secondaryText", size: "sm", inline: true, style: {
    textDecoration: "line-through"
  }, children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", (0, import_jsx_runtime47.jsxs)(Text, { color: "danger", size: "sm", inline: true, children: [formatNumber(Number(props.status.destination.amount), 6), " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: {
  ...
  const toTokenInfo = partialSuccessToTokenInfo || (0, import_jsx_runtime47.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] });
  const partialSuccessToChainInfo = ((_b = props.status) == null ? void 0 : _b.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination && props.status.destination.token.chainId !== props.status.quote.toToken.chainId ? (0, import_jsx_runtime47.jsxs)("div", { children: [(0, import_jsx_runtime47.jsx)(Text, { size: "xs", inline: true, style: {
    textDecoration: "line-through"
  }, children: toChainName.name }), " ", (0, import_jsx_runtime47.jsx)(Text, { size: "xs", inline: true, children: destinationName.name })] }) : null;
  const toTokehChainInfo = partialSuccessToChainInfo || (0, import_jsx_runtime47.jsx)(Text, { size: "xs", children: toChainName.name });
  ...
  return (0, import_jsx_runtime47.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime47.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime47.jsx)(PaymentStep, { title: (0, import_jsx_runtime47.jsxs)(Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
    icon: fiatIcon,
    primaryText: (0, import_jsx_runtime47.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(fromCurrencyAmount), 6), " ", fromCurrencySymbol] })
  }, to: {
  ...
  } : void 0 }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime47.jsx)(PaymentStep, { title: (0, import_jsx_runtime47.jsxs)(Text, { color: "primaryText", size: "md", children: ["Convert", " ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "to ", (0, import_jsx_runtime47.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "md", inline: true })] }), step: 2, from: {
    icon: onRampTokenIcon,
    primaryText: onRampTokenInfo,
    secondaryText: onRampChainInfo
  }, to: {
  ...
  } : void 0 }), isPartialSuccess && props.status && props.status.status !== "NOT_FOUND" && props.status.source && props.status.destination && (0, import_jsx_runtime47.jsxs)(import_jsx_runtime47.Fragment, { children: [(0, import_jsx_runtime47.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime47.jsxs)(Text, { color: "danger", size: "sm", center: true, children: ["Expected ", (_m = props.status.source) == null ? void 0 : _m.token.symbol, ", Got", " ", (_n = props.status.destination) == null ? void 0 : _n.token.symbol, " instead"] }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "sm" })] }), showContinueBtn && (0, import_jsx_runtime47.jsxs)(import_jsx_runtime47.Fragment, { children: [(0, import_jsx_runtime47.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime47.jsx)(Button, { variant: "accent", onClick: props.onContinue, fullWidth: true, children: "Continue" })] })] });
}
function PaymentStep(props) {
  return (0, import_jsx_runtime47.jsxs)(StepContainer, { state: props.state, children: [(0, import_jsx_runtime47.jsxs)(Text, { size: "sm", children: ["Step ", props.step] }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "sm" }), props.title, (0, import_jsx_runtime47.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime47.jsx)(Line, {}), (0, import_jsx_runtime47.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime47.jsx)(PaymentSubStep, { ...props.from }), (0, import_jsx_runtime47.jsxs)(Container, { color: "borderColor", style: {
    paddingLeft: "18px",
    position: "relative",
    marginBlock: "3px"
  }, children: [(0, import_jsx_runtime47.jsx)("div", { style: {
    height: "18px",
    width: "2px",
    backgroundColor: "currentColor",
    transform: "translateX(-50%)"
  } }), (0, import_jsx_runtime47.jsx)(TriangleDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    position: "absolute",
    bottom: "0",
    transform: "translate(-50%, 50%)"
  } })] }), (0, import_jsx_runtime47.jsx)(PaymentSubStep, { ...props.to }), props.explorer && (0, import_jsx_runtime47.jsxs)(import_jsx_runtime47.Fragment, { children: [(0, import_jsx_runtime47.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime47.jsxs)(ButtonLink, { variant: "outline", fullWidth: true, href: props.explorer.url, style: {
    fontSize: fontSize.xs,
    padding: spacing.xs
  }, gap: "xxs", target: "_blank", children: [props.explorer.label, (0, import_jsx_runtime47.jsx)(ExternalLinkIcon, { width: iconSize.xs, height: iconSize.xs })] })] })] });
}
function PaymentSubStep(props) {
  return (0, import_jsx_runtime47.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime47.jsx)(Container, { p: "xs", borderColor: "borderColor", flex: "row", center: "both", style: {
    borderStyle: "solid",
    borderWidth: "1.5px",
    borderRadius: radius.lg
  }, children: props.icon }), (0, import_jsx_runtime47.jsxs)(Container, { flex: "column", gap: "xxs", children: [props.primaryText, " ", props.secondaryText] })] });
}
function StepContainer(props) {
  ...
  return (0, import_jsx_runtime47.jsxs)(Container, { bg: "tertiaryBg", borderColor: color === "success" ? "borderColor" : color, py: "sm", px: "md", style: {
    borderRadius: radius.lg,
    ...
    position: "relative",
    ...props.style
  }, children: [props.children, (0, import_jsx_runtime47.jsxs)("div", { style: {
    position: "absolute",
    right: spacing.xs,
    top: spacing.xs,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center"
  }, children: [props.state && text && (0, import_jsx_runtime47.jsx)(Text, { size: "xs", color, children: text }), (props.state === "actionRequired" || props.state === "completed") && (0, import_jsx_runtime47.jsx)(StepIcon, { isActive: props.state === "actionRequired", isDone: props.state === "completed" }), props.state === "pending" && (0, import_jsx_runtime47.jsx)(Spinner, { color: "accentText", size: "sm" }), props.state === "failed" && (0, import_jsx_runtime47.jsx)(Container, { color: "danger", flex: "row", center: "both", children: (0, import_jsx_runtime47.jsx)(Cross1Icon, { width: iconSize.sm, height: iconSize.sm }) })] })] });
}
...
function StepBar(props) {
  return (0, import_jsx_runtime48.jsx)(Container, { bg: "tertiaryBg", flex: "row", style: {
    height: "8px",
    borderRadius: radius.lg
  }, children: (0, import_jsx_runtime48.jsx)(Container, { bg: "accentText", style: {
...
function SwitchNetworkButton(props) {
  const [isSwitching, setIsSwitching] = (0, import_react25.useState)(false);
  return (0, import_jsx_runtime49.jsx)(Button, { ...props, gap: "xs", onClick: async () => {
    setIsSwitching(true);
    try {
  ...
  }, children: isSwitching ? (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: ["Switching", (0, import_jsx_runtime49.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] }) : "Switch Network" });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/ErrorText.js
var import_jsx_runtime50 = __toESM(require_jsx_runtime(), 1);
function ErrorText(props) {
  return (0, import_jsx_runtime50.jsxs)(Container, { gap: "xxs", flex: "column", children: [(0, import_jsx_runtime50.jsxs)(Container, { flex: "row", gap: "xxs", center: "both", color: "danger", children: [(0, import_jsx_runtime50.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime50.jsx)(Text, { color: "danger", size: "sm", children: props.title })] }), (0, import_jsx_runtime50.jsx)(Text, { center: true, size: "xs", children: props.message })] });
}
...
function TokenRow(props) {
  ...
  if (!props.token || !props.chain) {
    return (0, import_jsx_runtime51.jsxs)(Button, { variant: "secondary", fullWidth: true, style: {
      fontSize: fontSize.sm,
      justifyContent: "space-between",
      paddingTop: spacing.md,
      paddingBottom: spacing.md,
      ...props.style
    }, gap: "xxs", onClick: props.onSelectToken, children: [(0, import_jsx_runtime51.jsx)(Text, { size: "sm", color: "primaryText", children: "Select payment token" }), (0, import_jsx_runtime51.jsx)(Container, { color: "primaryText", children: (0, import_jsx_runtime51.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm }) })] });
  }
  return (0, import_jsx_runtime51.jsxs)(TokenButton, { variant: "secondary", fullWidth: true, style: {
    fontSize: fontSize.sm,
    ...props.style
  }, gap: "xxs", onClick: props.onSelectToken, disabled: props.freezeChainAndToken, children: [(0, import_jsx_runtime51.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime51.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime51.jsxs)(Container, { flex: "column", gap: "4xs", children: [(0, import_jsx_runtime51.jsx)(Container, { flex: "column", gap: "4xs", children: props.isLoading ? (0, import_jsx_runtime51.jsx)(Skeleton, { width: "120px", height: fontSize.md, color: "borderColor" }) : props.value ? (0, import_jsx_runtime51.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", color: "primaryText", children: [(0, import_jsx_runtime51.jsx)(Text, { size: "md", color: props.value ? "primaryText" : "secondaryText", children: formatNumber(Number(props.value), 6) || "" }), (0, import_jsx_runtime51.jsx)(TokenSymbol, { token: props.token, chain: props.chain, color: "secondaryText", size: "sm" })] }) : (0, import_jsx_runtime51.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }) }), name ? (0, import_jsx_runtime51.jsx)(Text, { size: "xs", color: "secondaryText", children: name }) : (0, import_jsx_runtime51.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), !props.freezeChainAndToken && (0, import_jsx_runtime51.jsx)(Container, { color: "primaryText", children: (0, import_jsx_runtime51.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm }) })] });
}
...
function StepConnectorArrow() {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime52.jsx)(Container, { flex: "row", center: "both", style: {
    width: "100%",
    position: "relative",
    marginTop: "-10px",
    marginBottom: "-10px",
    zIndex: 1e3
  }, children: (0, import_jsx_runtime52.jsx)(Container, { flex: "row", center: "both", style: {
    borderRadius: "100%",
    width: "30px",
    height: "30px",
    backgroundColor: theme.colors.modalBg,
    border: `1px solid ${theme.colors.borderColor}`
  }, children: (0, import_jsx_runtime52.jsx)(ChevronDownIcon, { width: 16, height: 16 }) }) });
}
...
function WalletRow(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(Container, { flex: "row", style: { justifyContent: "space-between" }, children: (0, import_jsx_runtime53.jsxs)(Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [wallet ? (0, import_jsx_runtime53.jsx)(WalletImage, { id: wallet.id, size: iconSize[props.iconSize || "md"], client: props.client }) : (0, import_jsx_runtime53.jsx)(OutlineWalletIcon, { size: iconSize[props.iconSize || "md"] }), (0, import_jsx_runtime53.jsxs)(Container, { flex: "column", gap: "4xs", children: [props.label ? (0, import_jsx_runtime53.jsx)(Text, { size: "xs", color: "secondaryText", children: props.label }) : null, (0, import_jsx_runtime53.jsx)(Text, { size: props.textSize || "xs", color: "primaryText", children: addressOrENS || shortenAddress(props.address) }), profile.isLoading ? (0, import_jsx_runtime53.jsx)(Skeleton, { width: "100px", height: fontSize.sm }) : email || ((_c = walletInfo == null ? void 0 : walletInfo.data) == null ? void 0 : _c.name) ? (0, import_jsx_runtime53.jsx)(Text, { size: "xs", color: "secondaryText", children: email || ((_d = walletInfo == null ? void 0 : walletInfo.data) == null ? void 0 : _d.name) }) : null] })] }) });
}
...
function SwapSummary(props) {
  ...
  return (0, import_jsx_runtime54.jsxs)(Container, { children: [(0, import_jsx_runtime54.jsxs)(Container, { bg: "tertiaryBg", flex: "column", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`
  }, children: [(0, import_jsx_runtime54.jsx)(Container, { flex: "row", gap: "sm", p: "sm", style: {
    borderBottom: `1px solid ${theme.colors.borderColor}`
  }, children: (0, import_jsx_runtime54.jsx)(WalletRow, { address: props.sender, client: props.client, iconSize: "md", textSize: "sm" }) }), (0, import_jsx_runtime54.jsx)(TokenRow, { token: props.fromToken, chain: props.fromChain, client: props.client, isLoading: false, value: props.fromAmount, freezeChainAndToken: true, onSelectToken: () => {
  }, style: {
    background: "transparent",
    borderRadius: 0,
    border: "none"
  } })] }), (0, import_jsx_runtime54.jsx)(StepConnectorArrow, {}), (0, import_jsx_runtime54.jsxs)(Container, { flex: "column", bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`
  }, children: [isDifferentRecipient && (0, import_jsx_runtime54.jsx)(Container, { flex: "row", gap: "sm", p: "sm", style: {
    borderBottom: `1px solid ${theme.colors.borderColor}`
  }, children: (0, import_jsx_runtime54.jsx)(WalletRow, { address: props.receiver, client: props.client, iconSize: "md", textSize: "sm" }) }), (0, import_jsx_runtime54.jsx)(TokenRow, { token: props.toToken, chain: props.toChain, client: props.client, isLoading: false, value: props.toAmount, freezeChainAndToken: true, onSelectToken: () => {
  }, style: {
    background: "transparent",
    borderRadius: 0,
    border: "none"
...
function SwapConfirmationScreen(props) {
  ...
  const uiErrorMessage = (0, import_react26.useMemo)(() => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime55.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.isFiatFlow ? (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime55.jsx)(StepBar, { steps: 2, currentStep: 2 }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime55.jsxs)(Text, { size: "xs", children: ["Step 2 of 2 - Converting ", props.fromTokenSymbol, " to", " ", props.toTokenSymbol] }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "md" })] }) : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime55.jsx)(Text, { size: "sm", children: "Confirm payment" }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "md" })] }), (0, import_jsx_runtime55.jsx)(SwapSummary, { sender, receiver, client: props.client, fromToken: props.fromToken, fromChain: props.fromChain, toToken: props.toToken, toChain: props.toChain, fromAmount: props.fromAmount, toAmount: props.toAmount }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "md" }), needsApprovalStep && (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime55.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime55.jsx)(Step, { isDone: step === "swap", isActive: step === "approval", label: step === "approval" ? "Approve" : "Approved" }), (0, import_jsx_runtime55.jsx)(ConnectorLine, {}), (0, import_jsx_runtime55.jsx)(Step, { isDone: false, label: "Confirm", isActive: step === "swap" })] }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" })] }), uiErrorMessage && (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(ErrorText, { title: uiErrorMessage.title, message: uiErrorMessage.message }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "md" })] }), props.payer.chain.id !== props.fromChain.id ? (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime55.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(props.fromChain);
  } })] }) : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime55.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
    var _a;
  ...
  }, gap: "xs", children: [step === "approval" && (status === "pending" ? "Approving" : "Approve"), step === "swap" && (status === "pending" ? "Confirming" : "Confirm"), status === "pending" && (0, import_jsx_runtime55.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] })] });
}
...
function SwapDetailsScreen(props) {
  ...
  return (0, import_jsx_runtime56.jsxs)(Container, { children: [(0, import_jsx_runtime56.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime56.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime56.jsx)(Line, {}), (0, import_jsx_runtime56.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime56.jsx)(SwapTxDetailsTable, { type: "status", status, client }) })] });
}
function SwapTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime56.jsx)(Line, {}), (0, import_jsx_runtime56.jsx)(Spacer, { y: "md" })] });
  return (0, import_jsx_runtime56.jsxs)("div", { children: [(0, import_jsx_runtime56.jsx)(TokenInfoRow, { chainId: fromToken.chainId, client, label: "Paid", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, isPartialSuccess && gotToken ? (
    // Expected + Got
    (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: isPartialSuccess ? "Expected" : "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address }), lineSpacer, (0, import_jsx_runtime56.jsx)(TokenInfoRow, { chainId: gotToken.chainId, client, label: "Got", tokenAmount: gotToken.amount, tokenSymbol: gotToken.symbol || "", tokenAddress: gotToken.address })] })
  ) : (
    // Receive
    (0, import_jsx_runtime56.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })
  ), (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [lineSpacer, (0, import_jsx_runtime56.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime56.jsx)(Text, { size: "sm", children: "Recipient" }), (0, import_jsx_runtime56.jsx)(WalletRow, { address: uiData.toAddress, iconSize: "sm", client })] })] }), statusMeta && showStatusRow && (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [lineSpacer, (0, import_jsx_runtime56.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime56.jsx)(Text, { size: "sm", children: "Status" }), (0, import_jsx_runtime56.jsx)(Container, { flex: "column", gap: "3xs", center: "y", style: {
    alignItems: "flex-end"
  }, children: (0, import_jsx_runtime56.jsx)(Text, { color: statusMeta.color, size: "sm", children: statusMeta.status }) })] })] }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), ((_d = (_c = fromChainExplorers.explorers) == null ? void 0 : _c[0]) == null ? void 0 : _d.url) && sourceTxHash && (0, import_jsx_runtime56.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl((_e = fromChainExplorers.explorers[0]) == null ? void 0 : _e.url, sourceTxHash), target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime56.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }), destinationTxHash && sourceTxHash !== destinationTxHash && ((_g = (_f = toChainExplorers == null ? void 0 : toChainExplorers.explorers) == null ? void 0 : _f[0]) == null ? void 0 : _g.url) && (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime56.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl((_h = toChainExplorers.explorers[0]) == null ? void 0 : _h.url, destinationTxHash), target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", toChainName.name, " Explorer", (0, import_jsx_runtime56.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function SwapStatusScreen(props) {
  ...
  const [showDetails, setShowDetails] = (0, import_react27.useState)(false);
  ...
  const swapDetails = swapStatus.data && swapStatus.data.status !== "NOT_FOUND" ? (0, import_jsx_runtime57.jsx)(SwapTxDetailsTable, { status: swapStatus.data, type: "status", client: props.client }) : props.quote ? (0, import_jsx_runtime57.jsx)(SwapTxDetailsTable, { type: "quote", quote: props.quote, client: props.client }) : null;
  if (showDetails) {
    return (0, import_jsx_runtime57.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime57.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime57.jsx)(ModalHeader, { title: "Transaction Details", onBack: () => setShowDetails(false) }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), swapDetails] }) });
  }
  return (0, import_jsx_runtime57.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime57.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime57.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), uiStatus === "success" && (0, import_jsx_runtime57.jsxs)(import_jsx_runtime57.Fragment, { children: [(0, import_jsx_runtime57.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime57.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime57.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Complete" })] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime57.jsx)(Button, { variant: "outline", fullWidth: true, onClick: () => setShowDetails(true), children: "View transaction details" }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] }), uiStatus === "partialSuccess" && ((_e = swapStatus.data) == null ? void 0 : _e.status) !== "NOT_FOUND" && ((_f = swapStatus.data) == null ? void 0 : _f.destination) && (0, import_jsx_runtime57.jsxs)(import_jsx_runtime57.Fragment, { children: [(0, import_jsx_runtime57.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime57.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime57.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime57.jsx)(Text, { color: "primaryText", size: "lg", children: "Incomplete" }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsxs)(Text, { size: "sm", color: "danger", children: ["Expected ", swapStatus.data.quote.toToken.symbol, ", Got", " ", swapStatus.data.destination.token.symbol, " instead"] })] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" })] }), uiStatus === "failed" && (0, import_jsx_runtime57.jsxs)(import_jsx_runtime57.Fragment, { children: [(0, import_jsx_runtime57.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime57.jsxs)(Container, { flex: "column", children: [(0, import_jsx_runtime57.jsxs)(Container, { flex: "column", center: "both", children: [(0, import_jsx_runtime57.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime57.jsx)(Text, { color: "primaryText", size: "lg", children: "Transaction Failed" }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsxs)(Text, { size: "sm", children: ["Your transaction ", `couldn't`, " be processed"] })] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime57.jsx)(Button, { variant: "outline", fullWidth: true, onClick: () => setShowDetails(true), children: "View transaction details" }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onTryAgain, children: "Try Again" })] })] }), uiStatus === "pending" && (0, import_jsx_runtime57.jsxs)(import_jsx_runtime57.Fragment, { children: [(0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime57.jsxs)(Container, { flex: "column", animate: "fadein", center: "both", children: [(0, import_jsx_runtime57.jsx)("div", { style: {
    position: "relative",
    display: "flex",
    alignItems: "center",
    justifyContent: "center"
  }, children: (0, import_jsx_runtime57.jsx)(Spinner, { size: "3xl", color: "accentText" }) }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime57.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Pending" }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime57.jsx)(Text, { color: "secondaryText", size: "sm", children: "This may take a minute to complete" })] }), (0, import_jsx_runtime57.jsx)(Spacer, { y: "xl" })] })] }) });
}
...
function SwapFlow(props) {
  ...
  if (swapTxHash) {
    return (0, import_jsx_runtime58.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash, fromChain, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime58.jsx)(SwapConfirmationScreen, { title: props.title, setSwapTxHash, toChain, toAmount, toTokenSymbol, fromChain, toToken, fromAmount, fromToken, fromTokenSymbol, client: props.client, onBack: props.onBack, onTryAgain: props.onTryAgain, quote, isFiatFlow: props.isFiatFlow, payer: props.payer, preApprovedAmount: props.approvalAmount });
}
...
function PostOnRampSwap(props) {
  ...
  const allowanceQuery = useQuery({
    queryKey: [
      ...
      (_a = postOnRampQuoteQuery.data) == null ? void 0 : _a.approvalData
    ],
    queryFn: () => {
      var _a2;
      if (!((_a2 = postOnRampQuoteQuery.data) == null ? void 0 : _a2.approvalData)) {
        return null;
      }
      return allowance({
        contract: getContract({
    ...
    enabled: !!((_b = postOnRampQuoteQuery.data) == null ? void 0 : _b.approvalData),
    refetchOnMount: true
  });
  ...
  if (postOnRampQuoteQuery.isError) {
    return (0, import_jsx_runtime59.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime59.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime59.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime59.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", p: "lg", children: [(0, import_jsx_runtime59.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime59.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime59.jsx)(Text, { color: "primaryText", children: "Failed to get a price quote" }), (0, import_jsx_runtime59.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime59.jsx)(Button, { fullWidth: true, variant: "primary", onClick: () => {
      postOnRampQuoteQuery.refetch();
    }, children: "Try Again" })] }), (0, import_jsx_runtime59.jsx)(Spacer, { y: "xxl" })] });
  }
  if (!lockedOnRampQuote) {
    return (0, import_jsx_runtime59.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime59.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime59.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime59.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", children: [(0, import_jsx_runtime59.jsx)(Spinner, { size: "xxl", color: "accentText" }), (0, import_jsx_runtime59.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime59.jsx)(Text, { color: "primaryText", children: "Getting price quote" })] }), (0, import_jsx_runtime59.jsx)(Spacer, { y: "xxl" })] });
  }
  return (0, import_jsx_runtime59.jsx)(SwapFlow, { title: props.title, payer: props.payer, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
    setLockedOnRampQuote(void 0);
    postOnRampQuoteQuery.refetch();
  }, transactionMode: props.transactionMode, isEmbed: props.isEmbed, onSuccess: props.onSuccess, approvalAmount: allowanceQuery.data ?? void 0 });
}
...
function PostOnRampSwapFlow(props) {
  ...
  if (statusForSwap) {
    return (0, import_jsx_runtime60.jsx)(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime60.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
...
function FiatDetailsScreen(props) {
  ...
  if (hasTwoSteps) {
    ...
    return (0, import_jsx_runtime61.jsx)(PostOnRampSwapFlow, {
      title: props.title,
      client: props.client,
      status,
      onBack: props.onBack,
  ...
  return (0, import_jsx_runtime61.jsxs)(Container, { children: [(0, import_jsx_runtime61.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime61.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime61.jsx)(Line, {}), (0, import_jsx_runtime61.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime61.jsx)(OnRampTxDetailsTable, { client: props.client, token: status.source ? {
...
function TxDetailsScreen(props) {
  ...
  if (statusInfo.type === "swap") {
    return (0, import_jsx_runtime62.jsx)(SwapDetailsScreen, { client: props.client, status: statusInfo.status, onBack: props.onBack });
  }
  if (statusInfo.type === "fiat") {
    return (0, import_jsx_runtime62.jsx)(FiatDetailsScreen, { title: props.title, client: props.client, status: statusInfo.status, onBack: props.onBack, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer });
  }
  return null;
}
...
var ChainIcon2 = (props) => {
  return (0, import_jsx_runtime63.jsxs)(Container, { style: {
    ...
    flexShrink: 0,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime63.jsx)(Img, { src: getSrcChainIcon(props), width: props.size, height: props.size, fallbackImage: fallbackChainIcon, client: props.client }), props.active && (0, import_jsx_runtime63.jsx)(ChainActiveDot, { className: "tw-chain-active-dot-legacy-chain-icon" })] });
};
...
function WalletTransactionHistory(props) {
  ...
  return (0, import_jsx_runtime64.jsx)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: (0, import_jsx_runtime64.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [historicalTxQuery.isLoading && (0, import_jsx_runtime64.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime64.jsx)(Spinner, { color: "secondaryText", size: "md" }), (0, import_jsx_runtime64.jsx)(Text, { children: "Loading recent transactions..." })] }), !historicalTxQuery.isLoading && transactions.length === 0 ? (0, import_jsx_runtime64.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime64.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime64.jsx)(Text, { children: "No Transactions" })] }) : (0, import_jsx_runtime64.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", style: { minHeight: "250px" }, children: transactions.map((tx) => {
    var _a;
    return (0, import_jsx_runtime64.jsx)(TransactionButton, { explorerUrl: (_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url, client: props.client, tx }, tx.transactionHash);
  }) })] }) });
}
function TransactionButton(props) {
  ...
  const content = (0, import_jsx_runtime64.jsxs)(TxButton2, { variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime64.jsxs)(Container, { flex: "row", center: "y", gap: "md", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime64.jsx)(ChainIcon2, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), (0, import_jsx_runtime64.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime64.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime64.jsx)(Text, { size: "sm", color: "primaryText", children: (receipt == null ? void 0 : receipt.to) ? `Interacted with ${shortenHex(receipt == null ? void 0 : receipt.to, 4)}` : `Hash: ${shortenHex(props.tx.transactionHash, 4)}` }) }), (0, import_jsx_runtime64.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime64.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime64.jsx)(ChainName, { chain: getCachedChain(props.tx.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime64.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [isLoading && (0, import_jsx_runtime64.jsx)(Spinner, { size: "sm", color: "primaryText" }), !isLoading && receipt && receipt.status === "success" && (0, import_jsx_runtime64.jsx)(Text, { size: "md", color: "success", children: (0, import_jsx_runtime64.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }), (error || !isLoading && receipt && receipt.status !== "success") && (0, import_jsx_runtime64.jsx)(Text, { size: "md", color: "danger", children: (0, import_jsx_runtime64.jsx)(CrossCircledIcon, { width: iconSize.md, height: iconSize.md }) })] })] });
  if (props.explorerUrl) {
    return (0, import_jsx_runtime64.jsx)("a", { href: formatExplorerTxUrl(props.explorerUrl, props.tx.transactionHash), target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function TransactionsScreen(props) {
  ...
  if (selectedTx) {
    return (0, import_jsx_runtime65.jsx)(TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: () => setSelectedTx(null), payer, transactionMode: false, isEmbed: false });
  }
  return (0, import_jsx_runtime65.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime65.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime65.jsx)(ModalHeader, { title: props.locale.transactions, onBack: props.onBack }) }), (0, import_jsx_runtime65.jsx)(Line, {}), (0, import_jsx_runtime65.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime65.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime65.jsxs)(Tabs, { options: [
    {
      label: (0, import_jsx_runtime65.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime65.jsx)(CoinsIcon, { size: iconSize.sm }), " Transactions"] }),
      value: "Transactions"
    },
    {
      label: (0, import_jsx_runtime65.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime65.jsx)(FundsIcon, { size: iconSize.sm }), " Purchases"] }),
      value: "Purchases"
    }
  ], selected: activeTab, onSelect: setActiveTab, children: [activeTab === "Purchases" && (0, import_jsx_runtime65.jsx)(PayTxHistoryList, { client: props.client, onSelectTx: setSelectedTx }), activeTab === "Transactions" && (0, import_jsx_runtime65.jsx)(WalletTransactionHistory, { locale: props.locale, client: props.client, address: payer.account.address })] })] }), (0, import_jsx_runtime65.jsx)(Line, {}), (0, import_jsx_runtime65.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime65.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerAddressUrl(((_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url) ?? "", (activeAccount == null ? void 0 : activeAccount.address) ?? ""), target: "_blank", as: "a", gap: "xs", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: ["View on Explorer", (0, import_jsx_runtime65.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }) })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/LazyBuyScreen.js
var import_jsx_runtime66 = __toESM(require_jsx_runtime(), 1);
var import_react34 = __toESM(require_react(), 1);
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-A7SII5NF.js"));
function LazyBuyScreen(props) {
  return (0, import_jsx_runtime66.jsx)(import_react34.Suspense, { fallback: (0, import_jsx_runtime66.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime66.jsx)(BuyScreen, { ...props }) });
}
...
var SignatureScreen = (props) => {
  ...
  const [status, setStatus] = (0, import_react36.useState)(error ? "failed" : "idle");
  ...
  if (!wallet || siweAuth.isPending) {
    return (0, import_jsx_runtime67.jsx)(LoadingScreen, { "data-testid": "loading-screen" });
  }
  if (isHeadlessSignSupported(wallet.id) || wallet.id === "smart" && adminWallet && isHeadlessSignSupported(adminWallet.id)) {
    return (0, import_jsx_runtime67.jsx)(HeadlessSignIn, { error, signIn, status, connectLocale, wallet });
  }
  const handleRetry = () => {
    signIn();
  };
  return (0, import_jsx_runtime67.jsxs)(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, import_jsx_runtime67.jsx)(Container, { p: "lg", style: {
    paddingBottom: 0
  }, children: (0, import_jsx_runtime67.jsx)(ModalHeader, { title: locale.instructionScreen.title }) }), (0, import_jsx_runtime67.jsx)(Container, { style: {
    paddingTop: 0,
    paddingBottom: spacing.xl
  }, flex: "column", px: modalSize === "compact" ? "lg" : "xxl", center: "y", expand: true, children: status === "idle" ? (0, import_jsx_runtime67.jsxs)(import_jsx_runtime67.Fragment, { children: [(0, import_jsx_runtime67.jsx)(Container, { flex: "row", center: "x", animate: "fadein", py: "3xl", children: (0, import_jsx_runtime67.jsx)(PulsatingContainer, { children: (0, import_jsx_runtime67.jsx)(WalletImage, { id: wallet.id, client: props.client, size: "80" }) }) }), (0, import_jsx_runtime67.jsx)(Text, { center: true, multiline: true, balance: true, children: locale.instructionScreen.instruction }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsx)(Button, { fullWidth: true, variant: "accent", "data-testid": "sign-in-button", onClick: signIn, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.signInButton }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime67.jsx)(Button, { fullWidth: true, variant: "secondary", "data-testid": "disconnect-button", onClick: () => {
    onClose == null ? void 0 : onClose();
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.disconnectWallet })] }) : (0, import_jsx_runtime67.jsxs)(import_jsx_runtime67.Fragment, { children: [(0, import_jsx_runtime67.jsx)(Container, { py: "3xl", children: (0, import_jsx_runtime67.jsx)(WalletLogoSpinner, { client: props.client, error: status === "failed", id: wallet.id }) }), (0, import_jsx_runtime67.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [(0, import_jsx_runtime67.jsx)(Text, { size: "lg", center: true, color: "primaryText", children: status === "failed" ? error || locale.signingScreen.failedToSignIn : locale.signingScreen.inProgress }), status === "signing" && (0, import_jsx_runtime67.jsx)(Text, { center: true, multiline: true, balance: true, children: connectLocale.signatureScreen.signingScreen.prompt }), status === "failed" && (0, import_jsx_runtime67.jsxs)(Container, { children: [(0, import_jsx_runtime67.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime67.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: handleRetry, style: {
    gap: spacing.xs,
    alignItems: "center",
    padding: spacing.md
  }, children: [(0, import_jsx_runtime67.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), locale.signingScreen.tryAgain] }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime67.jsx)(Button, { fullWidth: true, variant: "secondary", onClick: () => {
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: locale.instructionScreen.disconnectWallet })] })] }, status)] }) }), (termsOfServiceUrl || privacyPolicyUrl) && (0, import_jsx_runtime67.jsx)(Container, { p: "md", animate: "fadein", children: (0, import_jsx_runtime67.jsx)(TOS, { termsOfServiceUrl, privacyPolicyUrl, locale: connectLocale.agreement }) })] });
};
...
function HeadlessSignIn({ signIn, error, status, connectLocale, wallet }) {
  ...
  return (0, import_jsx_runtime67.jsxs)(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime67.jsx)(ModalHeader, { title: locale.signingScreen.title }), (0, import_jsx_runtime67.jsxs)(Container, { expand: true, flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: [status === "signing" && (0, import_jsx_runtime67.jsx)(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (0, import_jsx_runtime67.jsxs)(Container, { children: [(0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsx)(Text, { size: "lg", center: true, color: "danger", children: error || locale.signingScreen.failedToSignIn }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => {
    signIn();
  }, style: {
    gap: spacing.xs,
    alignItems: "center",
...
function StartScreen(props) {
  ...
  if (WelcomeScreen) {
    if (typeof WelcomeScreen === "function") {
      return (0, import_jsx_runtime69.jsx)(WelcomeScreen, {});
    }
  }
  ...
  return (0, import_jsx_runtime69.jsxs)(Container, { fullHeight: true, animate: "fadein", flex: "column", children: [(0, import_jsx_runtime69.jsxs)(Container, { expand: true, flex: "column", center: "both", style: {
    minHeight: "300px"
  }, p: "lg", children: [(0, import_jsx_runtime69.jsx)(Container, { flex: "row", center: "x", children: img ? (0, import_jsx_runtime69.jsx)(Img, { src: img.src, width: img.width ? String(img.width) : void 0, height: img.height ? String(img.height) : void 0, client: props.client }) : (0, import_jsx_runtime69.jsx)(GlobalContainer, { children: (0, import_jsx_runtime69.jsx)(GlobeIcon, { size: "150" }) }) }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime69.jsx)(Text, { center: true, color: "primaryText", weight: 600, multiline: true, children: title }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime69.jsx)(Text, { color: "secondaryText", multiline: true, style: {
    textAlign: "center"
  }, children: subtitle }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime69.jsx)(Link, { target: "_blank", center: true, href: "https://blog.thirdweb.com/web3-wallet/", children: props.connectLocale.newToWallets })] }), (0, import_jsx_runtime69.jsx)(Container, { py: "lg", flex: "column", gap: "lg", children: (0, import_jsx_runtime69.jsxs)("div", { children: [showTOS && (0, import_jsx_runtime69.jsx)(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement }), props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime69.jsx)(Container, { style: {
    paddingTop: spacing.xl
  }, children: (0, import_jsx_runtime69.jsx)(PoweredByThirdweb, {}) })] }) })] });
}
...
function ConnectModalWideLayout(props) {
  return (0, import_jsx_runtime70.jsxs)("div", { style: {
    height: "100%",
    display: "grid",
    gridTemplateColumns: "300px 1fr"
  }, children: [(0, import_jsx_runtime70.jsxs)(LeftContainer, { children: [" ", props.left, " "] }), (0, import_jsx_runtime70.jsx)(Container, { flex: "column", scrollY: true, relative: true, children: props.right })] });
}
function ConnectModalCompactLayout(props) {
  return (0, import_jsx_runtime70.jsx)(Container, { flex: "column", scrollY: true, relative: true, style: {
    maxHeight: compactModalMaxHeight
  }, children: props.children });
}
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react38.lazy)(() => import("./AllWalletsUI-QEI2CJYK.js"));
var ConnectModalContent = (props) => {
  ...
  const walletList = (0, import_jsx_runtime71.jsx)(WalletSelector, { title: props.meta.title || props.connectLocale.defaultModalTitle, wallets: props.wallets, selectWallet: (newWallet) => {
  ...
  const showAll = (0, import_jsx_runtime71.jsx)(import_react38.Suspense, { fallback: (0, import_jsx_runtime71.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime71.jsx)(AllWalletsUI, { onBack: handleBack, onSelect: setScreen, client: props.client, connectLocale: props.connectLocale, recommendedWallets: props.recommendedWallets, specifiedWallets: props.wallets, size: props.size }) });
  const getStarted = (0, import_jsx_runtime71.jsx)(StartScreen, { client: props.client, connectLocale: props.connectLocale, meta: props.meta, welcomeScreen: props.welcomeScreen });
  const goBack = props.wallets.length > 1 ? handleBack : void 0;
  const getWalletUI = (wallet) => {
    if (props.accountAbstraction) {
      return (0, import_jsx_runtime71.jsx)(SmartConnectUI, { accountAbstraction: props.accountAbstraction, done: (smartWallet) => {
    ...
    return (0, import_jsx_runtime71.jsx)(AnyWalletConnectUI, { wallet, onBack: goBack, done: () => {
  ...
  const signatureScreen = (0, import_jsx_runtime71.jsx)(SignatureScreen, { onDone: onClose, onClose, modalSize: props.size, termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, auth: props.auth, client: props.client, connectLocale: props.connectLocale });
  return (0, import_jsx_runtime71.jsx)(ScreenSetupContext.Provider, { value: props.screenSetup, children: props.size === "wide" ? (0, import_jsx_runtime71.jsx)(ConnectModalWideLayout, { left: walletList, right: (0, import_jsx_runtime71.jsxs)(import_jsx_runtime71.Fragment, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && getStarted, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) }) : (0, import_jsx_runtime71.jsxs)(ConnectModalCompactLayout, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && walletList, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) });
};
...
function WalletSwitcherConnectionScreen(props) {
  ...
  return (0, import_jsx_runtime72.jsx)(ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: void 0, chain: props.chain || walletChain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, hideHeader: props.isEmbed, isOpen: true, meta: {
...
function WalletManagerScreen(props) {
  ...
  if (screen === "connect") {
    return (0, import_jsx_runtime73.jsx)(WalletSwitcherConnectionScreen, { ...props, isEmbed: false, onSelect: (w) => {
      setActive(w);
      props.onBack();
    } });
  }
  return (0, import_jsx_runtime73.jsxs)(Container, { children: [(0, import_jsx_runtime73.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime73.jsx)(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, import_jsx_runtime73.jsx)(Line, {}), (0, import_jsx_runtime73.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime73.jsx)(Container, { px: "md", style: {
    minHeight: "150px"
  }, children: (0, import_jsx_runtime73.jsx)(Container, { flex: "column", gap: "xs", children: connectedWallets.filter((w) => {
    var _a2;
    return !((_a2 = props.hiddenWallets) == null ? void 0 : _a2.includes(w.id));
  }).map((w) => {
    return (0, import_jsx_runtime73.jsx)(WalletManangerButton, {
      client: props.client,
      // address={address || ""}
      onClick: () => {
        setActive(w);
  ...
  }) }) }), (0, import_jsx_runtime73.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime73.jsx)(Container, { p: "lg", children: !hideConnectButton && (0, import_jsx_runtime73.jsxs)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    setScreen("connect");
  }, gap: "xs", children: [(0, import_jsx_runtime73.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }), "Connect Wallet"] }) })] });
}
function WalletManangerButton(props) {
  ...
  return (0, import_jsx_runtime73.jsxs)("div", { style: {
    position: "relative"
  }, children: [(0, import_jsx_runtime73.jsx)(WalletButtonEl, { onClick: props.onClick, style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime73.jsxs)(Container, { flex: "row", gap: "md", center: "y", children: [(0, import_jsx_runtime73.jsx)(WalletImage, { client: props.client, id: walletId, size: iconSize.lg }), (0, import_jsx_runtime73.jsxs)(Container, { flex: "column", gap: "4xs", children: [(0, import_jsx_runtime73.jsx)(Text, { color: "primaryText", children: shortenAddress(address || "") }), balanceQuery.data ? (0, import_jsx_runtime73.jsx)(Text, { size: "xs", color: "secondaryText", weight: 400, children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime73.jsx)(Skeleton, { width: "100px", height: fontSize.sm })] })] }) }), (0, import_jsx_runtime73.jsx)("div", { style: {
    position: "absolute",
    zIndex: 1,
    right: spacing.xxs,
    top: "50%",
    transform: "translateY(-50%)"
  }, children: (activeWallet == null ? void 0 : activeWallet.id) === props.wallet.id ? (0, import_jsx_runtime73.jsx)(ToolTip, { tip: "Active Wallet", children: (0, import_jsx_runtime73.jsx)(IconButton, { children: (0, import_jsx_runtime73.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }) }) : (0, import_jsx_runtime73.jsx)(ToolTip, { tip: "Disconnect", children: (0, import_jsx_runtime73.jsx)(IconButton, { onClick: () => {
    disconnect(props.wallet);
  }, children: (0, import_jsx_runtime73.jsx)(MinusIcon, { width: iconSize.md, height: iconSize.md, style: {
    color: theme.colors.secondaryText
  } }) }) }) })] });
}
...
var InAppWalletConnectUI = (0, import_react40.lazy)(() => import("./InAppWalletConnectUI-3AXP5CWF.js"));
function LinkProfileScreen(props) {
  ...
  if (!wallet) {
    return (0, import_jsx_runtime74.jsx)(LoadingScreen, {});
  }
  if (wallet.id === "inApp") {
    return (0, import_jsx_runtime74.jsx)(import_react40.Suspense, { fallback: (0, import_jsx_runtime74.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime74.jsx)(InAppWalletConnectUI, { walletConnect: props.walletConnect, wallet, done: () => {
      setTimeout(() => {
  ...
  if (isEcosystemWallet(wallet)) {
    return (0, import_jsx_runtime74.jsx)(import_react40.Suspense, { fallback: (0, import_jsx_runtime74.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime74.jsx)(EcosystemWalletConnectUI_default, { wallet, done: () => {
      setTimeout(() => {
        queryClient.invalidateQueries({ queryKey: ["profiles"] });
      }, 500);
      props.onBack();
  ...
  return (0, import_jsx_runtime74.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime74.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime74.jsx)(ModalHeader, { title: props.locale.manageWallet.linkProfile, onBack: props.onBack }) }), (0, import_jsx_runtime74.jsx)(Line, {}), (0, import_jsx_runtime74.jsxs)(Container, { flex: "column", gap: "md", center: "both", px: "xl", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime74.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime74.jsx)(Text, { center: true, children: "This wallet does not support account linking" })] })] });
}
...
var AddUserIcon = (props) => {
  return (0, import_jsx_runtime75.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime75.jsx)("path", { d: "M12 15.5H7.5C6.10444 15.5 5.40665 15.5 4.83886 15.6722C3.56045 16.06 2.56004 17.0605 2.17224 18.3389C2 18.9067 2 19.6044 2 21M19 21V15M16 18H22M14.5 7.5C14.5 9.98528 12.4853 12 10 12C7.51472 12 5.5 9.98528 5.5 7.5C5.5 5.01472 7.51472 3 10 3C12.4853 3 14.5 5.01472 14.5 7.5Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) });
};
...
function LinkedProfilesScreen(props) {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime76.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime76.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime76.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime76.jsx)(ModalHeader, { title: props.locale.manageWallet.linkedProfiles, onBack: props.onBack }) }), (0, import_jsx_runtime76.jsx)(Line, {}), (0, import_jsx_runtime76.jsxs)(Container, { scrollY: true, style: {
    height: "300px"
  }, children: [(0, import_jsx_runtime76.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime76.jsxs)(Container, { px: "sm", children: [(0, import_jsx_runtime76.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("link-profile");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime76.jsx)(AddUserIcon, { size: iconSize.lg }), (0, import_jsx_runtime76.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkProfile })] }), (0, import_jsx_runtime76.jsx)(Spacer, { y: "xs" }), connectedProfiles == null ? void 0 : connectedProfiles.filter((profile) => profile.type.toLowerCase() !== "guest" && profile.type.toLowerCase() !== "custom_jwt" && profile.type.toLowerCase() !== "custom_auth_endpoint").map((profile) => (0, import_jsx_runtime76.jsx)(LinkedProfile, { enableUnlinking: connectedProfiles.length > 1, profile, client: props.client }, `${JSON.stringify(profile)}`))] }), (0, import_jsx_runtime76.jsx)(Spacer, { y: "md" })] })] });
}
function LinkedProfile({ profile, enableUnlinking, client }) {
  ...
  return (0, import_jsx_runtime76.jsxs)(MenuButton, { style: {
    fontSize: fontSize.sm,
    cursor: "default"
  }, as: "div", disabled: true, children: [(socialProfiles == null ? void 0 : socialProfiles.some((p) => p.avatar)) ? (0, import_jsx_runtime76.jsx)(Img, { src: (_a = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _a.avatar, width: iconSize.lg, height: iconSize.lg, loading: "eager", client, style: {
    borderRadius: "100%"
  } }) : profile.details.address !== void 0 ? (0, import_jsx_runtime76.jsx)(Container, { style: {
    width: "32px",
    height: "32px",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: (0, import_jsx_runtime76.jsx)(Blobbie, { address: profile.details.address, size: 32 }) }) : profile.type === "passkey" ? (0, import_jsx_runtime76.jsx)(FingerPrintIcon, { size: iconSize.lg }) : profile.type === "email" ? (0, import_jsx_runtime76.jsx)(EmailIcon, { size: iconSize.lg }) : profile.type === "phone" ? (0, import_jsx_runtime76.jsx)(PhoneIcon, { size: iconSize.lg }) : (0, import_jsx_runtime76.jsx)(Img, { src: getSocialIcon(profile.type), width: iconSize.lg, height: iconSize.lg, loading: "eager", client }), (0, import_jsx_runtime76.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
    flexGrow: 1
  }, children: [(0, import_jsx_runtime76.jsx)(Text, { color: "primaryText", children: ((_b = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _b.name) || getProfileDisplayName(profile) }), (0, import_jsx_runtime76.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "row",
    alignItems: "center",
    gap: "8px"
  }, children: [((_c = socialProfiles == null ? void 0 : socialProfiles.find((p) => p.avatar)) == null ? void 0 : _c.name) && profile.details.address && (0, import_jsx_runtime76.jsx)(Text, { color: "secondaryText", size: "sm", children: shortenAddress(profile.details.address, 4) }), enableUnlinking && (0, import_jsx_runtime76.jsx)(IconButton, { autoFocus: true, type: "button", "aria-label": "Unlink", onClick: () => unlinkProfileMutation({
    client,
    profileToUnlink: profile
  }), style: {
    pointerEvents: "auto"
  }, disabled: isPending, children: (0, import_jsx_runtime76.jsx)(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
    color: "inherit"
  } }) })] })] })] });
}
...
var KeyIcon = (props) => {
  return (0, import_jsx_runtime77.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", children: [(0, import_jsx_runtime77.jsx)("path", { d: "M2 5.99999L2 2.99999C2 2.39999 2.4 1.99999 3 1.99999H7L7 4.99999H10V7.99999H12L13.4 9.39999C14.7898 8.91585 16.3028 8.9177 17.6915 9.40524C19.0801 9.89278 20.2622 10.8372 21.0444 12.0839C21.8265 13.3306 22.1624 14.8058 21.9971 16.2683C21.8318 17.7307 21.1751 19.0937 20.1344 20.1344C19.0937 21.1751 17.7307 21.8318 16.2683 21.9971C14.8058 22.1624 13.3306 21.8265 12.0839 21.0444C10.8372 20.2622 9.89279 19.0801 9.40525 17.6915C8.91771 16.3028 8.91585 14.7898 9.4 13.4L2 5.99999Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime77.jsx)("path", { d: "M15.5 15C15.7761 15 16 15.2239 16 15.5C16 15.7761 15.7761 16 15.5 16C15.2239 16 15 15.7761 15 15.5C15 15.2239 15.2239 15 15.5 15Z", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/MultiUserIcon.js
var import_jsx_runtime78 = __toESM(require_jsx_runtime(), 1);
var MultiUserIcon = (props) => {
  return (0, import_jsx_runtime78.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime78.jsx)("path", { d: "M22 21V19C22 17.1362 20.7252 15.5701 19 15.126M15.5 3.29076C16.9659 3.88415 18 5.32131 18 7C18 8.67869 16.9659 10.1159 15.5 10.7092M17 21C17 19.1362 17 18.2044 16.6955 17.4693C16.2895 16.4892 15.5108 15.7105 14.5307 15.3045C13.7956 15 12.8638 15 11 15H8C6.13623 15 5.20435 15 4.46927 15.3045C3.48915 15.7105 2.71046 16.4892 2.30448 17.4693C2 18.2044 2 19.1362 2 21M13.5 7C13.5 9.20914 11.7091 11 9.5 11C7.29086 11 5.5 9.20914 5.5 7C5.5 4.79086 7.29086 3 9.5 3C11.7091 3 13.5 4.79086 13.5 7Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) });
};
...
function ManageWalletScreen(props) {
  ...
  return (0, import_jsx_runtime80.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime80.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime80.jsx)(ModalHeader, { title: props.locale.manageWallet.title, onBack: props.onBack }) }), (0, import_jsx_runtime80.jsx)(Line, {}), (0, import_jsx_runtime80.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime80.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime80.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [(0, import_jsx_runtime80.jsx)(SwitchMetamaskAccount, { closeModal: props.closeModal, connectLocale: props.locale }), typeof wallet !== "undefined" && ((_a = props.manageWallet) == null ? void 0 : _a.allowLinkingProfiles) !== false && (0, import_jsx_runtime80.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("linked-profiles");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime80.jsx)(MultiUserIcon, { size: iconSize.md }), (0, import_jsx_runtime80.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkedProfiles })] }), (0, import_jsx_runtime80.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("wallet-connect-receiver");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime80.jsx)(WalletConnectIcon, { size: iconSize.md }), (0, import_jsx_runtime80.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.connectAnApp })] }), wallet && isInAppWallet(wallet) && !((_b = wallet.getConfig()) == null ? void 0 : _b.hidePrivateKeyExport) && (0, import_jsx_runtime80.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("private-key");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime80.jsx)(KeyIcon, { size: iconSize.md }), (0, import_jsx_runtime80.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.exportPrivateKey })] })] }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "lg" })] })] });
}
function SwitchMetamaskAccount(props) {
  ...
  return (0, import_jsx_runtime80.jsxs)(MenuButton, { type: "button", onClick: async () => {
    await injectedMetamaskProvider.request({
      method: "wallet_requestPermissions",
      params: [{ eth_accounts: {} }]
    });
    props.closeModal();
  }, children: [(0, import_jsx_runtime80.jsx)(ShuffleIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime80.jsx)(Text, { color: "primaryText", children: connectLocale.switchAccount })] });
}
...
function PrivateKey(props) {
  ...
  return (0, import_jsx_runtime81.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime81.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime81.jsx)(ModalHeader, { title: props.connectLocale.manageWallet.exportPrivateKey, onBack: props.onBack }) }), (0, import_jsx_runtime81.jsx)(Line, {}), (0, import_jsx_runtime81.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime81.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime81.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [isLoading ? (0, import_jsx_runtime81.jsx)(Container, { center: "both", flex: "column", style: { position: "absolute", width: "100%", height: "100%" }, children: (0, import_jsx_runtime81.jsx)(Spinner, { size: "lg", color: "primaryButtonBg" }) }) : (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, {}), (0, import_jsx_runtime81.jsx)(Container, { style: {
    position: "absolute",
    height: "100%",
    width: "100%",
    zIndex: 11
  }, children: (0, import_jsx_runtime81.jsx)("iframe", { id: `export-wallet-${props.wallet.id}`, title: "Export In-App Wallet", style: {
    width: "100%",
    height: "250px",
    visibility: isLoading ? "hidden" : "unset"
  }, onLoad: () => {
    setLoading(false);
  }, allow: "clipboard-read; clipboard-write", src: `${baseDomain}/sdk/2022-08-12/embedded-wallet/export-private-key?clientId=${props.client.clientId}&theme=${typeof props.theme === "string" ? props.theme : props.theme.type}${ecosystem ? `&ecosystemId=${ecosystem.id}` : ""}${(ecosystem == null ? void 0 : ecosystem.partnerId) ? `&partnerId=${ecosystem.partnerId}` : ""}` }) })] }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "lg" })] })] });
}
...
function ReceiveFunds(props) {
  ...
  return (0, import_jsx_runtime82.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime82.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime82.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime82.jsx)(QRCode, { qrCodeUri: address, size: 310, QRIcon: props.walletId && (0, import_jsx_runtime82.jsx)(WalletImage, { id: props.walletId, size: iconSize.xxl, client }) }) }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime82.jsxs)(WalletAddressContainer, { onClick: onCopy, children: [(0, import_jsx_runtime82.jsx)(Text, { color: "primaryText", size: "md", children: shortenString(address || "") }), (0, import_jsx_runtime82.jsx)(CopyIcon2, { text: address || "", tip: "Copy address", hasCopied })] }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime82.jsx)(Text, { multiline: true, center: true, balance: true, className: "receive_fund_screen_instruction", children: locale.instruction })] });
}
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-F6UTZ4MH.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-KM6543T5.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-JDXBJM4L.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-CQJVOB7D.js");
...
function TokenSelector(props) {
  ...
  if (screen === "select-chain" && chainSelection) {
    return (0, import_jsx_runtime83.jsx)(NetworkSelectorContent, {
      client: props.client,
      ...
      networkSelector: {
        renderChain(renderChainProps) {
          return (0, import_jsx_runtime83.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
  ...
  return (0, import_jsx_runtime83.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime83.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime83.jsx)(ModalHeader, { onBack: props.onBack, title: props.modalTitle || locale.selectTokenTitle }) }), (0, import_jsx_runtime83.jsx)(Line, {}), (0, import_jsx_runtime83.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "450px"
  }, children: [(0, import_jsx_runtime83.jsx)(Spacer, { y: "md" }), props.chainSelection && (0, import_jsx_runtime83.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime83.jsx)(Text, { size: "sm", children: "Select Network" }), (0, import_jsx_runtime83.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime83.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: () => {
    setScreen("select-chain");
  }, children: [(0, import_jsx_runtime83.jsx)(ChainIcon2, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), chainNameQuery.name ? (0, import_jsx_runtime83.jsx)(Text, { color: "primaryText", size: "sm", children: chainNameQuery.name }) : (0, import_jsx_runtime83.jsx)(Skeleton, { height: fontSize.md }), (0, import_jsx_runtime83.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    marginLeft: "auto"
  } })] }), (0, import_jsx_runtime83.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime83.jsx)(Text, { size: "sm", children: "Select Token" })] }), (0, import_jsx_runtime83.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime83.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime83.jsx)(Input, { placeholder: locale.searchToken, variant: "outline", value: input, onChange: (e) => {
    setInput(e.target.value);
  } })] }), (0, import_jsx_runtime83.jsx)(Spacer, { y: "md" }), (filteredList.length > 0 || !input) && (0, import_jsx_runtime83.jsxs)(Container, { flex: "column", gap: "xs", px: "lg", scrollY: true, style: {
    paddingTop: 0,
    paddingBottom: spacing.lg
  }, children: [!input && (0, import_jsx_runtime83.jsx)(SelectTokenButton, { onClick: () => {
    props.onTokenSelect(NATIVE_TOKEN);
  }, chain: props.chain, token: NATIVE_TOKEN, client: props.client }), filteredList.map((token) => {
    return (0, import_jsx_runtime83.jsx)(SelectTokenButton, { onClick: () => props.onTokenSelect(token), token, chain: props.chain, client: props.client }, token.address);
  })] }), filteredList.length === 0 && tokenQuery.isLoading && input && (0, import_jsx_runtime83.jsx)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: (0, import_jsx_runtime83.jsx)(Spinner, { size: "lg", color: "accentText" }) }), filteredList.length === 0 && !tokenQuery.isLoading && input && (0, import_jsx_runtime83.jsxs)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: [(0, import_jsx_runtime83.jsx)(CrossCircledIcon, { width: iconSize.lg, height: iconSize.lg }), locale.noTokensFound] }), (0, import_jsx_runtime83.jsx)(Spacer, { y: "md" })] })] });
}
function SelectTokenButton(props) {
  ...
  return (0, import_jsx_runtime83.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: props.onClick, children: [(0, import_jsx_runtime83.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime83.jsxs)(Container, { flex: "column", gap: "4xs", children: [tokenName ? (0, import_jsx_runtime83.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime83.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), account && (0, import_jsx_runtime83.jsx)(TokenBalance, { account, chain: props.chain, client: props.client, tokenAddress: isNativeToken(props.token) ? void 0 : props.token.address })] })] });
}
function TokenBalance(props) {
  ...
  if (tokenBalanceQuery.data) {
    return (0, import_jsx_runtime83.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] });
  }
  return (0, import_jsx_runtime83.jsx)(Skeleton, { height: fontSize.xs, width: "100px" });
}
...
function SendFunds(props) {
  ...
  if (screen === "tokenSelector" && chain) {
    return (0, import_jsx_runtime84.jsx)(TokenSelector, { tokenList, onBack: () => {
      setScreen("base");
  ...
  return (0, import_jsx_runtime84.jsx)(SendFundsForm, { token, onTokenSelect: () => {
...
function SendFundsForm(props) {
  ...
  if (sendTokenMutation.isError) {
    return (0, import_jsx_runtime84.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime84.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime84.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "200px"
    }, color: "danger", children: [(0, import_jsx_runtime84.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime84.jsx)(Text, { center: true, multiline: true, color: "danger", children: getErrorMessage2(sendTokenMutation.error) })] })] });
  }
  if (sendTokenMutation.isSuccess) {
    return (0, import_jsx_runtime84.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime84.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime84.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "250px"
    }, color: "success", children: [(0, import_jsx_runtime84.jsx)(CheckCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime84.jsxs)(Text, { color: "success", children: [" ", locale.successMessage, " "] })] })] });
  }
  ...
  return (0, import_jsx_runtime84.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime84.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime84.jsxs)("form", { onSubmit: (e) => {
    e.preventDefault();
  }, children: [(0, import_jsx_runtime84.jsx)(Label, { htmlFor: "token", color: "secondaryText", children: locale.token }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime84.jsxs)(Button, { id: "token", variant: "outline", fullWidth: true, style: {
    justifyContent: "flex-start",
    gap: spacing.sm,
    padding: spacing.sm
  }, onClick: props.onTokenSelect, children: [(0, import_jsx_runtime84.jsx)(TokenIcon, { token: props.token, chain: activeChain, size: "lg", client: props.client }), (0, import_jsx_runtime84.jsxs)(Container, { flex: "column", gap: "xs", children: [tokenName ? (0, import_jsx_runtime84.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime84.jsx)(Skeleton, { height: fontSize.xs, width: "150px" }), balanceQuery.data ? (0, import_jsx_runtime84.jsx)(Text, { size: "xs", children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime84.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime84.jsx)(Label, { htmlFor: "receiver", color: "secondaryText", children: locale.sendTo }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime84.jsx)(Input, { required: true, id: "receiver", placeholder: "0x... or ENS name", variant: "outline", value: receiverAddress, onChange: (e) => {
    setReceiverAddress(e.target.value);
  } }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime84.jsx)(Label, { htmlFor: "amount", color: "secondaryText", children: locale.amount }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime84.jsxs)(Container, { relative: true, children: [(0, import_jsx_runtime84.jsx)(Input, { required: true, type: "number", id: "amount", variant: "outline", value: amount, onChange: (e) => {
    setAmount(e.target.value);
  } }), (0, import_jsx_runtime84.jsx)(CurrencyBadge, { children: (0, import_jsx_runtime84.jsxs)(Text, { size: "xs", children: [" ", tokenSymbol, " "] }) })] }), (0, import_jsx_runtime84.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime84.jsxs)(Button, { fullWidth: true, variant: "accent", type: "submit", className: "tw-sendfunds-screen-send-button", onClick: async () => {
    ...
    gap: spacing.sm,
    padding: spacing.md
  }, children: [sendTokenMutation.isPending && (0, import_jsx_runtime84.jsx)(Spinner, { size: "sm", color: "accentButtonText" }), sendTokenMutation.isPending ? locale.sending : locale.submitButton] })] })] });
}
...
var ImageIcon = (props) => {
  return (0, import_jsx_runtime85.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", role: "presentation", children: [(0, import_jsx_runtime85.jsx)("rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2" }), (0, import_jsx_runtime85.jsx)("circle", { cx: "9", cy: "9", r: "2" }), (0, import_jsx_runtime85.jsx)("path", { d: "m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" })] });
};
...
var CarbonDocumentUnknown = (props) => {
  return (0, import_jsx_runtime86.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime86.jsx)("circle", { cx: "9", cy: "28.5", r: "1.5", fill: "currentColor" }), (0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "M10 25H8v-4h2a2 2 0 0 0 0-4H8a2.002 2.002 0 0 0-2 2v.5H4V19a4.005 4.005 0 0 1 4-4h2a4 4 0 0 1 0 8Z" }), (0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "m27.7 9.3l-7-7A.908.908 0 0 0 20 2H10a2.006 2.006 0 0 0-2 2v8h2V4h8v6a2.006 2.006 0 0 0 2 2h6v16H14v2h12a2.006 2.006 0 0 0 2-2V10a.91.91 0 0 0-.3-.7ZM20 10V4.4l5.6 5.6Z" })] });
};
var CarbonDocumentAudio = (props) => {
  return (0, import_jsx_runtime86.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "M29 31a.999.999 0 0 1-.625-.22L23.65 27H20a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h3.65l4.726-3.78A1 1 0 0 1 30 17v13a1 1 0 0 1-1 1Zm-8-6h3a1 1 0 0 1 .625.22L28 27.92v-8.84l-3.376 2.7A1 1 0 0 1 24 22h-3Z" }), (0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "M16 28H8V4h8v6a2.006 2.006 0 0 0 2 2h6v3h2v-5a.91.91 0 0 0-.3-.7l-7-7A.909.909 0 0 0 18 2H8a2.006 2.006 0 0 0-2 2v24a2.006 2.006 0 0 0 2 2h8Zm2-23.6l5.6 5.6H18Z" })] });
};
var CarbonPauseFilled = (props) => {
  return (0, import_jsx_runtime86.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "M12 6h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zm10 0h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" }) });
};
var CarbonPlayFilledAlt = (props) => {
  return (0, import_jsx_runtime86.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime86.jsx)("path", { fill: "currentColor", d: "M7 28a1 1 0 0 1-1-1V5a1 1 0 0 1 1.482-.876l20 11a1 1 0 0 1 0 1.752l-20 11A1 1 0 0 1 7 28Z" }) });
};
...
// node_modules/thirdweb/dist/esm/react/web/ui/MediaRenderer/MediaRenderer.js
var MediaRenderer = (() => (0, import_react45.forwardRef)(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className }, ref) {
  var _a;
  const mergedStyle = {
    objectFit: "contain",
    ...style
  ...
  if (!mediaInfoIsFetched || !src) {
    return (0, import_jsx_runtime87.jsx)("div", { style });
  }
  if (mediaInfo.mimeType) {
    if (mediaInfo.mimeType.startsWith("text/html")) {
      return (0, import_jsx_runtime87.jsx)(IframePlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, ref, requireInteraction, className, alt });
    }
    ...
    if (mediaInfo.mimeType.startsWith("video")) {
      return (0, import_jsx_runtime87.jsx)(VideoPlayer, { style: mergedStyle, src: mediaInfo.url, ref, poster: ((_a = possiblePosterSrc.mimeType) == null ? void 0 : _a.startsWith("image/")) ? possiblePosterSrc.url : void 0, requireInteraction, className, controls });
    }
    if (mediaInfo.mimeType.startsWith("audio")) {
      return (0, import_jsx_runtime87.jsx)(AudioPlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, alt, ref, className, height, width, controls });
    }
    if (mediaInfo.mimeType.startsWith("image/")) {
      return (0, import_jsx_runtime87.jsx)(ImageRenderer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className, height, width });
    }
  }
  return (0, import_jsx_runtime87.jsx)(LinkPlayer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className });
}))();
var PlayButton = ({ onClick, isPlaying }) => {
  ...
  return (0, import_jsx_runtime87.jsx)("button", { type: "button", style: {
    position: "absolute",
    bottom: 0,
    right: 0,
  ...
  }, onClick, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp, children: !isPlaying ? (0, import_jsx_runtime87.jsx)(CarbonPlayFilledAlt, {}) : (0, import_jsx_runtime87.jsx)(CarbonPauseFilled, {}) });
};
var ImageRenderer = (() => (0, import_react45.forwardRef)(function Image_Renderer(props, ref) {
  const { style, src, alt, className, height, width } = props;
  const [error, setError] = (0, import_react45.useState)(false);
  if (error) {
    return (0, import_jsx_runtime87.jsx)(LinkPlayer, { style, src, alt, ref, className });
  }
  return (0, import_jsx_runtime87.jsx)("img", { style, src: src ?? void 0, alt, ref, className, height, width, onError: () => {
    setError(true);
  } });
}))();
var VideoPlayer = (() => (0, import_react45.forwardRef)(function Video_Player({ src, alt, poster, requireInteraction, style, width, height, controls, className }, ref) {
  ...
  return (0, import_jsx_runtime87.jsxs)("div", { style: { position: "relative", ...style }, className, children: [(0, import_jsx_runtime87.jsx)("video", { ref: mergeRefs2([videoRef, ref]), src: src ?? void 0, poster: poster ?? void 0, loop: true, playsInline: true, controlsList: "nodownload", muted, preload: poster ? "metadata" : "auto", onCanPlay: () => {
    var _a;
    if (playing) {
  ...
  } }), poster && (0, import_jsx_runtime87.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
    ...
    right: 0,
    bottom: 0
  }, alt }), (0, import_jsx_runtime87.jsx)(PlayButton, { onClick: () => {
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing })] });
}))();
var AudioPlayer = (() => (0, import_react45.forwardRef)(function Audio_Player({ src, alt, poster, style, height, width, className, controls }, ref) {
  ...
  return (0, import_jsx_runtime87.jsxs)("div", { style: { position: "relative", ...style }, className, children: [poster ? (0, import_jsx_runtime87.jsx)("img", { height, width, src: poster, style: {
    height: "100%",
    width: "100%",
    pointerEvents: "none",
    objectFit: "contain"
  }, alt }) : (0, import_jsx_runtime87.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    ...
    backgroundColor: "#fff",
    color: "rgb(138, 147, 155)"
  }, children: (0, import_jsx_runtime87.jsx)(CarbonDocumentAudio, { style: { height: "64px", width: "64px" } }) }), (0, import_jsx_runtime87.jsx)(PlayButton, { onClick: () => {
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing }), (0, import_jsx_runtime87.jsx)("audio", { ref: mergeRefs2([audioRef, ref]), src: src ?? void 0, loop: true, playsInline: true, controls, muted, preload: "none", controlsList: "nodownload", style: {
    position: "absolute",
    opacity: 0,
    pointerEvents: "none",
    zIndex: -1,
...
var IframePlayer = (() => (0, import_react45.forwardRef)(function Iframe_Player({ src, alt, poster, requireInteraction, style, ...restProps }, ref) {
  const [playing, setPlaying] = (0, import_react45.useState)(!requireInteraction);
  return (0, import_jsx_runtime87.jsxs)("div", { style: { position: "relative", ...style }, ...restProps, children: [(0, import_jsx_runtime87.jsx)("iframe", { title: alt || "thirdweb iframe player", src: playing ? src ?? void 0 : void 0, ref, style: {
    objectFit: "contain",
    zIndex: 1,
    height: "100%",
    width: "100%",
    ...
    opacity: !poster ? 1 : playing ? 1 : 0,
    border: "none"
  }, sandbox: "allow-scripts", allow: "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" }), poster && (0, import_jsx_runtime87.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
...
var LinkPlayer = (() => (0, import_react45.forwardRef)(function Link_Player({ src, alt, style, className }, ref) {
  return (0, import_jsx_runtime87.jsx)("div", { style: { position: "relative", ...style }, className, children: (0, import_jsx_runtime87.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    backgroundColor: "#fff",
    color: "rgb(138, 147, 155)"
  }, children: (0, import_jsx_runtime87.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: "8px",
    alignItems: "center",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime87.jsx)(CarbonDocumentUnknown, { style: {
    maxWidth: "128px",
    minWidth: "48px",
    width: "50%",
    aspectRatio: "1"
  } }), (0, import_jsx_runtime87.jsx)("a", { rel: "noopener noreferrer", style: {
...
function ViewNFTs(props) {
  return (0, import_jsx_runtime88.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime88.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime88.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.viewNFTs, onBack: props.onBack }) }), (0, import_jsx_runtime88.jsx)(Line, {}), (0, import_jsx_runtime88.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime88.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime88.jsx)(ViewNFTsContent, { ...props })] })] });
}
function ViewNFTsContent(props) {
  ...
  return (0, import_jsx_runtime88.jsxs)(import_jsx_runtime88.Fragment, { children: [nftQuery.error ? (0, import_jsx_runtime88.jsx)(Container, { center: "both", py: "lg", children: (0, import_jsx_runtime88.jsx)(Text, { size: "sm", color: "secondaryText", center: true, children: "Error loading NFTs" }) }) : ((_c = nftQuery.data) == null ? void 0 : _c.length) === 0 && !nftQuery.isLoading ? (0, import_jsx_runtime88.jsx)(Container, { center: "both", py: "lg", children: (0, import_jsx_runtime88.jsx)(Text, { size: "sm", color: "secondaryText", center: true, children: "No NFTs found on this chain" }) }) : (0, import_jsx_runtime88.jsx)(Container, { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: "12px"
  }, children: nftQuery.isLoading || !filteredNFTs ? (0, import_jsx_runtime88.jsxs)(import_jsx_runtime88.Fragment, { children: [(0, import_jsx_runtime88.jsx)(Skeleton, { height: "150px", width: "150px" }), (0, import_jsx_runtime88.jsx)(Skeleton, { height: "150px", width: "150px" }), (0, import_jsx_runtime88.jsx)(Skeleton, { height: "150px", width: "150px" })] }) : filteredNFTs.map((nft) => (0, import_jsx_runtime88.jsx)(NftCard, { ...nft, client: props.client, chain: nft.chain, theme: props.theme }, `${nft.chain.id}:${nft.address}:${nft.id}`)) }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "lg" })] });
}
function NftCard(props) {
  ...
  const content = (0, import_jsx_runtime88.jsxs)("div", { style: {
    display: "flex",
    width: "150px",
    flexDirection: "column",
    gap: "4px",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime88.jsxs)("div", { style: {
    position: "relative",
    display: "flex",
    flexShrink: 0,
    alignItems: "center",
  ...
  }, children: [props.metadata.image && (0, import_jsx_runtime88.jsx)(MediaRenderer, { src: props.metadata.image, style: {
    width: "100%",
    height: "100%"
  }, client: props.client }), props.quantityOwned > 1 && (0, import_jsx_runtime88.jsx)("div", { style: {
    position: "absolute",
    bottom: "4px",
    right: "4px",
    ...
    justifyContent: "center",
    borderRadius: "100%"
  }, children: props.quantityOwned.toString() }), props.chain.icon && (0, import_jsx_runtime88.jsx)("img", { alt: props.chain.name, style: {
    position: "absolute",
    bottom: "4px",
    left: "4px",
    width: "20px",
    height: "20px"
  }, src: props.chain.icon.url })] }), (0, import_jsx_runtime88.jsx)(Text, { size: "xs", color: "primaryText", style: {
    fontWeight: 600,
    textAlign: "center",
    maxLines: 2
  }, children: props.metadata.name })] });
  if (props.chain.name) {
    return (0, import_jsx_runtime88.jsx)("a", { href: `https://thirdweb.com/${props.chain.id}/${props.address}/nfts/${props.id}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function ViewTokens(props) {
  return (0, import_jsx_runtime89.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime89.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime89.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.viewTokens, onBack: props.onBack }) }), (0, import_jsx_runtime89.jsx)(Line, {}), (0, import_jsx_runtime89.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime89.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime89.jsx)(ViewTokensContent, { ...props }), (0, import_jsx_runtime89.jsx)(Spacer, { y: "lg" })] })] });
}
function ViewTokensContent(props) {
  ...
  return (0, import_jsx_runtime89.jsxs)(import_jsx_runtime89.Fragment, { children: [(0, import_jsx_runtime89.jsx)(TokenInfo, { token: NATIVE_TOKEN, chain: activeChain, client: props.client }), tokenList.map((token) => {
    return (0, import_jsx_runtime89.jsx)(TokenInfo, { token, chain: activeChain, client: props.client }, token.address);
  }), erc20TokensQuery.isLoading && (0, import_jsx_runtime89.jsxs)(Container, { flex: "column", gap: "sm", p: "sm", children: [(0, import_jsx_runtime89.jsx)(Skeleton, { height: fontSize.md, width: "100%" }), (0, import_jsx_runtime89.jsx)(Skeleton, { height: fontSize.md, width: "100%" })] }), (_a = erc20TokensQuery.data) == null ? void 0 : _a.map((token) => {
    return (0, import_jsx_runtime89.jsx)(TokenInfo, { token: {
...
function TokenInfo(props) {
  ...
  return (0, import_jsx_runtime89.jsxs)(Container, { flex: "row", gap: "sm", p: "sm", children: [(0, import_jsx_runtime89.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime89.jsxs)(Container, { flex: "column", gap: "xxs", children: [tokenName ? (0, import_jsx_runtime89.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime89.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), props.balanceData ? (0, import_jsx_runtime89.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(props.balanceData)] }) : tokenBalanceQuery.data ? (0, import_jsx_runtime89.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] }) : (0, import_jsx_runtime89.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/ViewAssets.js
var TokenTab = {
  label: (0, import_jsx_runtime90.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime90.jsx)(CoinsIcon, { size: iconSize.sm }), " Tokens"] }),
  value: "Tokens"
};
var NftTab = {
  label: (0, import_jsx_runtime90.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime90.jsx)(ImageIcon, { size: iconSize.sm }), " NFTs"] }),
  value: "NFTs"
};
function ViewAssets(props) {
  ...
  const [activeTab, setActiveTab] = (0, import_react46.useState)(((_a = options[0]) == null ? void 0 : _a.value) || "Tokens");
  return (0, import_jsx_runtime90.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime90.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime90.jsx)(ModalHeader, { title: connectLocale.viewFunds.viewAssets, onBack: props.onBack }) }), (0, import_jsx_runtime90.jsx)(Line, {}), (0, import_jsx_runtime90.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime90.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime90.jsx)(Tabs, { options, selected: activeTab, onSelect: setActiveTab, children: (0, import_jsx_runtime90.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "300px"
  }, children: [activeTab === "Tokens" && (0, import_jsx_runtime90.jsx)(ViewTokensContent, { client: props.client, connectLocale, supportedTokens: props.supportedTokens }), activeTab === "NFTs" && (0, import_jsx_runtime90.jsx)(ViewNFTsContent, { supportedNFTs: props.supportedNFTs, client: props.client, theme: props.theme, connectLocale })] }) }), (0, import_jsx_runtime90.jsx)(Spacer, { y: "lg" })] })] });
}
...
function WalletConnectDisconnectScreen(props) {
  return (0, import_jsx_runtime91.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime91.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime91.jsx)(ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, import_jsx_runtime91.jsx)(Line, {}), (0, import_jsx_runtime91.jsx)(Container, { px: "lg", scrollY: true, style: {
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime91.jsxs)(Container, { py: "lg", style: { position: "relative" }, children: [(0, import_jsx_runtime91.jsx)(Container, { py: "md", children: (0, import_jsx_runtime91.jsx)(WalletLogoSpinner, { client: props.client, error: !!props.error, id: "walletConnect", hideSpinner: true }) }), (0, import_jsx_runtime91.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !props.error ? (0, import_jsx_runtime91.jsxs)(import_jsx_runtime91.Fragment, { children: [(0, import_jsx_runtime91.jsxs)(Text, { balance: true, center: true, multiline: true, size: "md", children: ["Connected to ", props.session.origin ?? "another app."] }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime91.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.disconnect();
  }, children: "Disconnect" })] }) : (0, import_jsx_runtime91.jsxs)(import_jsx_runtime91.Fragment, { children: [(0, import_jsx_runtime91.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: props.error }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime91.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime91.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => props.disconnect(), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime91.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), "Retry"] }) })] }) })] }) })] });
}
...
function WalletConnectReceiverScreen(props) {
  ...
  if (session) {
    return (0, import_jsx_runtime92.jsx)(WalletConnectDisconnectScreen, { disconnect, error: errorConnecting, ...props, session });
  }
  return (0, import_jsx_runtime92.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime92.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime92.jsx)(ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, import_jsx_runtime92.jsx)(Line, {}), (0, import_jsx_runtime92.jsx)(Container, { px: "lg", scrollY: true, style: {
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime92.jsxs)(Container, { py: "sm", style: { position: "relative" }, children: [(0, import_jsx_runtime92.jsx)(Container, { py: "md", children: (0, import_jsx_runtime92.jsx)(WalletLogoSpinner, { client: props.client, error: !!errorConnecting, id: "walletConnect", hideSpinner: !loading }) }), (0, import_jsx_runtime92.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !errorConnecting ? (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Text, { balance: true, center: true, multiline: true, size: "sm", children: "Copy your connection URI from the external app." }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime92.jsx)(InputSelectionUI, { type: "text", disabled: loading || !!errorConnecting || !walletConnectClient, onSelect: async (value) => {
    setLoading(true);
    if (!walletConnectClient) {
  ...
  }, placeholder: "WalletConnect URI", name: "wcUri", emptyErrorMessage: "Please enter a valid URI", submitButtonText: "Connect" })] }) : (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [(0, import_jsx_runtime92.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: errorConnecting }), (0, import_jsx_runtime92.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime92.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime92.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => setErrorConnecting(false), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime92.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), "Retry"] }) })] }) })] }) }), (0, import_jsx_runtime92.jsxs)(Container, { children: [(0, import_jsx_runtime92.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime92.jsx)(Line, {}), (0, import_jsx_runtime92.jsx)(Container, { flex: "row", center: "x", p: "lg", children: (0, import_jsx_runtime92.jsx)("a", { href: "https://blog.thirdweb.com/p/a62c0ef4-1d8f-424d-95b9-a006e5239849/", children: (0, import_jsx_runtime92.jsx)(Button, { variant: "link", onClick: () => {
...
var ConnectedWalletDetails = (props) => {
  ...
  if ((_a = props.detailsButton) == null ? void 0 : _a.render) {
    return (
      ...
      (0, import_jsx_runtime93.jsx)("div", { onClick: openModal, children: (0, import_jsx_runtime93.jsx)(props.detailsButton.render, {}) })
    );
  }
  if (props.chain && isNetworkMismatch) {
    return (0, import_jsx_runtime93.jsx)(SwitchNetworkButton2, { style: (_b = props.switchButton) == null ? void 0 : _b.style, className: (_c = props.switchButton) == null ? void 0 : _c.className, switchNetworkBtnTitle: (_d = props.switchButton) == null ? void 0 : _d.label, targetChain: props.chain, connectLocale: locale });
  }
  ...
  return (0, import_jsx_runtime93.jsxs)(WalletInfoButton, { type: "button", className: combinedClassName, style: (_h = props.detailsButton) == null ? void 0 : _h.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, import_jsx_runtime93.jsx)(Container, { style: {
    borderRadius: "100%",
    overflow: "hidden",
    width: "35px",
    height: "35px"
  }, children: ((_i = props.detailsButton) == null ? void 0 : _i.connectedAccountAvatarUrl) ? (0, import_jsx_runtime93.jsx)("img", { alt: "", src: props.detailsButton.connectedAccountAvatarUrl, style: {
    height: "100%",
    width: "100%",
    objectFit: "cover"
  } }) : (0, import_jsx_runtime93.jsx)(AccountAvatar, { className: `${TW_CONNECTED_WALLET}__account_avatar`, loadingComponent: (0, import_jsx_runtime93.jsx)(AccountBlobbie, { size: 35, className: `${TW_CONNECTED_WALLET}__account_avatar` }), fallbackComponent: (0, import_jsx_runtime93.jsx)(AccountBlobbie, { size: 35, className: `${TW_CONNECTED_WALLET}__account_avatar` }), queryOptions: {
    refetchOnWindowFocus: false,
    refetchOnMount: false
  }, style: {
    height: "100%",
    width: "100%",
    objectFit: "cover"
  } }) }), (0, import_jsx_runtime93.jsxs)(Container, { flex: "column", gap: "4xs", style: {
    textOverflow: "ellipsis",
    whiteSpace: "nowrap",
    borderRadius: `0 ${radius.md} ${radius.md} 0`
  }, children: [((_j = props.detailsButton) == null ? void 0 : _j.connectedAccountName) ? (0, import_jsx_runtime93.jsx)(Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: props.detailsButton.connectedAccountName }) : (0, import_jsx_runtime93.jsx)(Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: (0, import_jsx_runtime93.jsx)(AccountName, { loadingComponent: (0, import_jsx_runtime93.jsx)(AccountAddress, { formatFn: shortenAddress }), fallbackComponent: (0, import_jsx_runtime93.jsx)(AccountAddress, { formatFn: shortenAddress }) }) }), (0, import_jsx_runtime93.jsx)(Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", color: "secondaryText", weight: 400, style: {
    display: "flex",
    gap: "2px",
    alignItems: "center"
  }, children: ((_k = props.detailsButton) == null ? void 0 : _k.showBalanceInFiat) ? (0, import_jsx_runtime93.jsxs)(import_jsx_runtime93.Fragment, { children: [(0, import_jsx_runtime93.jsx)(AccountBalance, { chain: walletChain, loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: fontSize.xs, width: "50px" }), fallbackComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: fontSize.xs, width: "50px" }), tokenAddress }), (0, import_jsx_runtime93.jsx)(AccountBalance, { chain: walletChain, tokenAddress, showBalanceInFiat: "USD", formatFn: detailsBtn_formatFiatBalanceForButton, loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: fontSize.xs, width: "20px" }) })] }) : (0, import_jsx_runtime93.jsx)(AccountBalance, { chain: walletChain, loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: fontSize.xs, width: "70px" }), fallbackComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: fontSize.xs, width: "70px" }), formatFn: detailsBtn_formatTokenBalanceForButton, tokenAddress }) })] })] });
};
...
function DetailsModal(props) {
  ...
  const closeModal = (0, import_react48.useCallback)(() => {
    setIsOpen(false);
    onModalUnmount(() => {
      props.closeModal();
    });
  ...
  const avatarContent = (0, import_jsx_runtime93.jsxs)(Container, { style: {
    position: "relative",
    height: `${iconSize.xl}px`,
    width: `${iconSize.xl}px`
  }, children: [(0, import_jsx_runtime93.jsx)(Container, { style: {
    width: "100%",
    height: "100%",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: ((_a = props.detailsModal) == null ? void 0 : _a.connectedAccountAvatarUrl) ? (0, import_jsx_runtime93.jsx)("img", { src: props.detailsModal.connectedAccountAvatarUrl, style: {
    height: "100%",
    width: "100%",
    objectFit: "cover"
  }, alt: "" }) : activeAccount && (0, import_jsx_runtime93.jsx)(AccountAvatar, { loadingComponent: (0, import_jsx_runtime93.jsx)(AccountBlobbie, { size: Number(iconSize.xxl) }), fallbackComponent: (0, import_jsx_runtime93.jsx)(AccountBlobbie, { size: Number(iconSize.xxl) }), style: {
    height: "100%",
    width: "100%",
    objectFit: "cover"
  } }) }), !((_b = props.detailsModal) == null ? void 0 : _b.hideSwitchWallet) ? (0, import_jsx_runtime93.jsx)(Container, { style: {
    position: "absolute",
    bottom: -2,
    right: -2
  }, children: (0, import_jsx_runtime93.jsx)(IconContainer, { style: {
    background: theme.colors.modalBg
  }, padding: "4px", children: activeWallet && (0, import_jsx_runtime93.jsx)(WalletImage, { style: { borderRadius: 0 }, id: activeWallet.id, client, size: "12" }) }) }) : null] });
  let content = (0, import_jsx_runtime93.jsxs)("div", { className: `${TW_CONNECTED_WALLET}__default_modal_screen`, children: [(0, import_jsx_runtime93.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime93.jsxs)(Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
    paddingTop: spacing.lg,
    paddingBottom: hideAllButtons ? spacing.md : spacing.lg
  }, children: [((_c = props.detailsModal) == null ? void 0 : _c.hideSwitchWallet) ? avatarContent : (0, import_jsx_runtime93.jsx)(ToolTip, { tip: "Switch wallet", children: (0, import_jsx_runtime93.jsx)("div", { style: {
    cursor: "pointer"
  }, onKeyDown: (e) => {
    if (e.key === "w") {
    ...
    setScreen("wallet-manager");
  }, children: avatarContent }) }), (0, import_jsx_runtime93.jsxs)(Container, { flex: "column", gap: "3xs", children: [(0, import_jsx_runtime93.jsxs)("div", { style: {
    display: "flex",
    gap: spacing.xxs,
    alignItems: "center"
  }, children: [((_d = props.detailsModal) == null ? void 0 : _d.connectedAccountName) ? (0, import_jsx_runtime93.jsx)(Text, { color: "primaryText", weight: 500, size: "md", children: props.detailsModal.connectedAccountName }) : (0, import_jsx_runtime93.jsx)(Text, { color: "primaryText", weight: 500, size: "md", children: (0, import_jsx_runtime93.jsx)(AccountName, { loadingComponent: (0, import_jsx_runtime93.jsx)(AccountAddress, { formatFn: shortenAddress }), fallbackComponent: (0, import_jsx_runtime93.jsx)(AccountAddress, { formatFn: shortenAddress }) }) }), (0, import_jsx_runtime93.jsx)(IconButton, { children: (0, import_jsx_runtime93.jsx)(CopyIcon2, { text: (activeAccount == null ? void 0 : activeAccount.address) || "", tip: locale.copyAddress }) })] }), (0, import_jsx_runtime93.jsx)(InAppWalletUserInfo, { client, locale })] })] }), !hideAllButtons && (0, import_jsx_runtime93.jsxs)(import_jsx_runtime93.Fragment, { children: [(0, import_jsx_runtime93.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime93.jsxs)(Container, { style: {
    display: "flex",
    gap: spacing.xs
  }, children: [!hideSendFunds && (0, import_jsx_runtime93.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("send");
  }, children: [(0, import_jsx_runtime93.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime93.jsx)(PaperPlaneIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "translateY(-10%) rotate(-45deg) "
  } }) }), locale.send] }), !hideReceiveFunds && (0, import_jsx_runtime93.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("receive");
  }, children: [(0, import_jsx_runtime93.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime93.jsx)(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }) }), locale.receive] }), !hideBuyFunds && (0, import_jsx_runtime93.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("buy");
  }, children: [(0, import_jsx_runtime93.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime93.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }) }), locale.buy] })] }) }), (0, import_jsx_runtime93.jsx)(Spacer, { y: "md" })] }), (0, import_jsx_runtime93.jsxs)(Container, { px: "md", children: [(0, import_jsx_runtime93.jsxs)(Container, { flex: "column", style: {
    gap: "1px"
  }, children: [(0, import_jsx_runtime93.jsx)(NetworkSwitcherButton, { client: props.client, setScreen: () => setScreen("network-switcher"), disableSwitchChain, showBalanceInFiat: (_e = props.detailsModal) == null ? void 0 : _e.showBalanceInFiat, displayBalanceToken: props.displayBalanceToken }), (0, import_jsx_runtime93.jsxs)(MenuButton, { onClick: () => {
    setScreen("transactions");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime93.jsx)(TextAlignJustifyIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime93.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime93.jsx)(Text, { color: "primaryText", children: locale.transactions }) })] }), (props.assetTabs === void 0 || props.assetTabs.length > 0) && (0, import_jsx_runtime93.jsxs)(MenuButton, { onClick: () => {
    setScreen("view-assets");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime93.jsx)(CoinsIcon, { size: iconSize.md }), (0, import_jsx_runtime93.jsx)(Text, { color: "primaryText", children: locale.viewFunds.viewAssets })] }), (0, import_jsx_runtime93.jsxs)(MenuButton, { onClick: () => {
    setScreen("manage-wallet");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime93.jsx)(OutlineWalletIcon, { size: iconSize.md }), (0, import_jsx_runtime93.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.title })] }), (((_f = props.detailsModal) == null ? void 0 : _f.showTestnetFaucet) ?? false) && (chainFaucetsQuery.faucets.length > 0 || (walletChain == null ? void 0 : walletChain.id) === LocalhostChainId) && (0, import_jsx_runtime93.jsxs)(MenuLink, { href: chainFaucetsQuery.faucets ? chainFaucetsQuery.faucets[0] : "#", target: "_blank", as: "a", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: [(0, import_jsx_runtime93.jsx)(Container, { flex: "row", center: "both", color: "secondaryText", children: (0, import_jsx_runtime93.jsx)(FundsIcon, { size: iconSize.md }) }), locale.requestTestnetFunds] }), ((_g = props.detailsModal) == null ? void 0 : _g.footer) && (0, import_jsx_runtime93.jsx)(props.detailsModal.footer, { close: closeModal })] }), (0, import_jsx_runtime93.jsx)(Spacer, { y: "md" })] }), ((_h = props.detailsModal) == null ? void 0 : _h.hideDisconnect) !== true && (0, import_jsx_runtime93.jsxs)(Container, { children: [(0, import_jsx_runtime93.jsx)(Line, {}), (0, import_jsx_runtime93.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime93.jsx)(Container, { px: "md", children: (0, import_jsx_runtime93.jsxs)(MenuButton, { "data-variant": "danger", type: "button", onClick: () => {
  ...
  if (screen === "network-switcher") {
    ...
    content = (0, import_jsx_runtime93.jsx)(ViewAssets, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
      setScreen("main");
    ...
    content = (0, import_jsx_runtime93.jsx)(ViewNFTs, { theme: props.theme, supportedNFTs: props.supportedNFTs, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "view-tokens") {
    content = (0, import_jsx_runtime93.jsx)(ViewTokens, { supportedTokens: props.supportedTokens, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "private-key") {
    content = (0, import_jsx_runtime93.jsx)(PrivateKey, { theme: props.theme, onBack: () => {
      setScreen("manage-wallet");
    }, wallet: activeWallet, client, connectLocale: locale });
  } else if (screen === "manage-wallet") {
    content = (0, import_jsx_runtime93.jsx)(ManageWalletScreen, { onBack: () => {
      setScreen("main");
    }, locale, closeModal, client, setScreen });
  } else if (screen === "wallet-connect-receiver") {
    content = (0, import_jsx_runtime93.jsx)(WalletConnectReceiverScreen, { onBack: () => {
      setScreen("manage-wallet");
    }, chains: props.chains, client });
  } else if (screen === "linked-profiles") {
    content = (0, import_jsx_runtime93.jsx)(LinkedProfilesScreen, { onBack: () => setScreen("manage-wallet"), client, locale, setScreen });
  } else if (screen === "link-profile") {
    content = (0, import_jsx_runtime93.jsx)(LinkProfileScreen, { onBack: () => {
      setScreen("linked-profiles");
    }, client, locale, walletConnect: (_t = props.connectOptions) == null ? void 0 : _t.walletConnect });
  } else if (screen === "send") {
    content = (0, import_jsx_runtime93.jsx)(SendFunds, { supportedTokens: props.supportedTokens, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "receive") {
    content = (0, import_jsx_runtime93.jsx)(ReceiveFunds, { walletId: activeWallet == null ? void 0 : activeWallet.id, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "buy") {
    content = (0, import_jsx_runtime93.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_u = props.detailsModal) == null ? void 0 : _u.payOptions) || {
      mode: "fund_wallet"
  ...
  return (0, import_jsx_runtime93.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime93.jsx)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: (0, import_jsx_runtime93.jsx)(ScreenSetupContext.Provider, { value: screenSetup, children: (0, import_jsx_runtime93.jsx)(Modal, { size: "compact", open: isOpen, setOpen: (_open) => {
    var _a2, _b2;
    if (!_open) {
      closeModal();
  ...
  }, children: (activeAccount == null ? void 0 : activeAccount.address) && (0, import_jsx_runtime93.jsx)(AccountProvider, { address: activeAccount.address, client, children: content }) }) }) }) });
}
function NetworkSwitcherButton(props) {
  ...
  return (0, import_jsx_runtime93.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
    setScreen("network-switcher");
  }, "data-variant": "primary", className: "tw-internal-network-switcher-button", children: [(0, import_jsx_runtime93.jsxs)(ChainProvider, { chain: walletChain, children: [(0, import_jsx_runtime93.jsx)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: (0, import_jsx_runtime93.jsxs)(Container, { style: {
    position: "relative",
    display: "flex",
    flexShrink: 0,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime93.jsx)(ChainIcon, { client, loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: `${iconSize.md}px`, width: `${iconSize.md}px` }), fallbackComponent: (0, import_jsx_runtime93.jsx)("img", { src: fallbackChainIcon, alt: "", style: {
    width: `${iconSize.md}px`,
    height: `${iconSize.md}px`
  } }), style: {
    width: `${iconSize.md}px`,
    height: `${iconSize.md}px`
  } }), (0, import_jsx_runtime93.jsx)(ChainActiveDot, { className: "tw-chain-active-dot-details-button" })] }) }), (0, import_jsx_runtime93.jsxs)(Text, { color: "primaryText", size: "md", multiline: true, children: [(0, import_jsx_runtime93.jsx)(ChainName2, { loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "16px", width: "150px" }), fallbackComponent: (0, import_jsx_runtime93.jsxs)("span", { children: ["Unknown chain #", walletChain == null ? void 0 : walletChain.id] }) }), (0, import_jsx_runtime93.jsx)(Text, { color: "secondaryText", size: "xs", children: showBalanceInFiat ? (0, import_jsx_runtime93.jsxs)(import_jsx_runtime93.Fragment, { children: [(0, import_jsx_runtime93.jsx)(AccountBalance, { fallbackComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "1em", width: "70px" }), loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "1em", width: "70px" }), chain: walletChain, tokenAddress: (_a = props.displayBalanceToken) == null ? void 0 : _a[Number(walletChain == null ? void 0 : walletChain.id)], formatFn: (props2) => formatAccountTokenBalance({ ...props2, decimals: 7 }) }), " ", (0, import_jsx_runtime93.jsx)(AccountBalance, { loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "1em", width: "30px" }), chain: walletChain, tokenAddress: (_b = props.displayBalanceToken) == null ? void 0 : _b[Number(walletChain == null ? void 0 : walletChain.id)], formatFn: (props2) => ` (${formatAccountFiatBalance({ ...props2, decimals: 3 })})`, showBalanceInFiat: "USD" })] }) : (0, import_jsx_runtime93.jsx)(AccountBalance, { fallbackComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "1em", width: "100px" }), loadingComponent: (0, import_jsx_runtime93.jsx)(Skeleton, { height: "1em", width: "100px" }), formatFn: (props2) => formatAccountTokenBalance({ ...props2, decimals: 7 }), chain: walletChain, tokenAddress: (_c = props.displayBalanceToken) == null ? void 0 : _c[Number(walletChain == null ? void 0 : walletChain.id)] }) })] })] }), (0, import_jsx_runtime93.jsx)(StyledChevronRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    flexShrink: 0,
    marginLeft: "auto"
  } })] });
}
...
function ConnectedToSmartWallet(props) {
  const activeAccount = useActiveAccount();
  const activeWallet = useActiveWallet();
  const isSmartWallet2 = hasSmartAccount(activeWallet);
  const chain = useActiveWalletChain();
  ...
  (0, import_react48.useEffect)(() => {
    if (activeAccount && isSmartWallet2 && activeAccount.address && chain) {
      const contract = getContract({
        address: activeAccount.address,
        chain,
        client
  ...
  }, [activeAccount, chain, client, isSmartWallet2]);
  const content = (0, import_jsx_runtime93.jsx)(Container, { flex: "row", gap: "3xs", center: "y", children: (0, import_jsx_runtime93.jsx)(Text, { size: "xs", weight: 400, color: "secondaryText", children: locale.connectedToSmartWallet }) });
  if (chain && activeAccount && isSmartWallet2) {
    return (0, import_jsx_runtime93.jsx)(import_jsx_runtime93.Fragment, { children: isSmartWalletDeployed ? (0, import_jsx_runtime93.jsx)(Link, { color: "secondaryText", hoverColor: "primaryText", href: `https://thirdweb.com/${chain.id}/${activeAccount.address}/account`, target: "_blank", size: "sm", children: content }) : (0, import_jsx_runtime93.jsxs)(Text, { size: "sm", children: [" ", content] }) });
  }
  return null;
}
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-UKNQL2XA.js");
  ...
  if (!userInfoQuery.data && isSmartWallet2) {
    return (0, import_jsx_runtime93.jsx)(ConnectedToSmartWallet, { client, connectLocale: locale });
  }
  if (userInfoQuery.data || walletName) {
    return (0, import_jsx_runtime93.jsx)(Text, { size: "xs", weight: 400, children: userInfoQuery.data || walletName });
  }
  return (0, import_jsx_runtime93.jsx)(Skeleton, { width: "50px", height: "10px", className: "InAppWalletUserInfo__skeleton" });
}
function SwitchNetworkButton2(props) {
  ...
  return (0, import_jsx_runtime93.jsx)(Button, { className: `tw-connect-wallet--switch-network ${props.className || ""}`, variant: "primary", type: "button", "data-is-loading": switching, "data-test": "switch-network-button", disabled: switching, onClick: async () => {
    setSwitching(true);
    try {
    ...
    minWidth: "140px",
    ...props.style
  }, "aria-label": switching ? locale.switchingNetwork : void 0, children: switching ? (0, import_jsx_runtime93.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : switchNetworkBtnTitle });
}
function useWalletDetailsModal() {
  ...
  function openModal(props) {
    ...
    getConnectLocale(props.locale || "en_US").then((locale) => {
      setRootEl((0, import_jsx_runtime93.jsx)(DetailsModal, { client: props.client, locale, detailsModal: {
        footer: props.footer,
...
var ConnectModal = (props) => {
  ...
  return (0, import_jsx_runtime94.jsx)(Modal, { hide: hideModal, size: props.size, open: isWalletModalOpen, setOpen: (value) => {
    if (hideModal) {
      return;
    }
    if (!value) {
...
var LockIcon = (props) => {
  return (0, import_jsx_runtime95.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 16 21", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime95.jsx)("path", { d: "M2 21C1.45 21 0.979333 20.8043 0.588 20.413C0.196 20.021 0 19.55 0 19V9C0 8.45 0.196 7.979 0.588 7.587C0.979333 7.19567 1.45 7 2 7H3V5C3 3.61667 3.48767 2.43733 4.463 1.462C5.43767 0.487333 6.61667 0 8 0C9.38333 0 10.5627 0.487333 11.538 1.462C12.5127 2.43733 13 3.61667 13 5V7H14C14.55 7 15.021 7.19567 15.413 7.587C15.8043 7.979 16 8.45 16 9V19C16 19.55 15.8043 20.021 15.413 20.413C15.021 20.8043 14.55 21 14 21H2ZM8 16C8.55 16 9.021 15.8043 9.413 15.413C9.80433 15.021 10 14.55 10 14C10 13.45 9.80433 12.979 9.413 12.587C9.021 12.1957 8.55 12 8 12C7.45 12 6.97933 12.1957 6.588 12.587C6.196 12.979 6 13.45 6 14C6 14.55 6.196 15.021 6.588 15.413C6.97933 15.8043 7.45 16 8 16ZM5 7H11V5C11 4.16667 10.7083 3.45833 10.125 2.875C9.54167 2.29167 8.83333 2 8 2C7.16667 2 6.45833 2.29167 5.875 2.875C5.29167 3.45833 5 4.16667 5 5V7Z", fill: "currentColor" }) });
};
...
function ConnectButton(props) {
  ...
  const size4 = (0, import_react50.useMemo)(() => {
    var _a2;
  ...
  const autoConnectComp = props.autoConnect !== false && (0, import_jsx_runtime96.jsx)(AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, wallets, timeout: typeof props.autoConnect === "boolean" ? void 0 : (_d = props.autoConnect) == null ? void 0 : _d.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect });
  if (!localeQuery.data) {
    const combinedClassName = `${((_e = props.connectButton) == null ? void 0 : _e.className) || ""} ${TW_CONNECT_WALLET}`;
    return (0, import_jsx_runtime96.jsxs)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      ...(_f = props.connectButton) == null ? void 0 : _f.style
    }, children: [autoConnectComp, (0, import_jsx_runtime96.jsx)(Spinner, { size: "sm", color: "primaryButtonText" })] });
  }
  return (0, import_jsx_runtime96.jsxs)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: [(0, import_jsx_runtime96.jsx)(ConnectButtonInner, { ...props, connectLocale: localeQuery.data }), (0, import_jsx_runtime96.jsx)(ConnectModal_default, { shouldSetActive: true, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: preferredChain, chains: props.chains, client: props.client, connectLocale: localeQuery.data, meta: {
...
function ConnectButtonInner(props) {
  ...
  if (!activeAccount) {
    ...
    return (0, import_jsx_runtime96.jsx)(AnimatedButton, { disabled: isLoading, className: combinedClassName, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      fontSize: "16px",
    ...
    }, "data-test": "connect-wallet-button", children: isLoading ? (0, import_jsx_runtime96.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : connectButtonLabel });
  }
  if (siweAuth.requiresAuth) {
    if (siweAuth.isPending || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
      ...
      return (0, import_jsx_runtime96.jsx)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
        minWidth: "165px",
        height: "50px",
        ...(_e = props.connectButton) == null ? void 0 : _e.style
      }, children: (0, import_jsx_runtime96.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) });
    }
    if (!siweAuth.isLoggedIn) {
      return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime96.Fragment, { children: [(0, import_jsx_runtime96.jsx)(Button, { variant: "primary", type: "button", onClick: () => {
        setShowSignatureModal(true);
      }, className: (_f = props.signInButton) == null ? void 0 : _f.className, style: {
        minWidth: "165px",
        minHeight: "50px",
        ...(_g = props.signInButton) == null ? void 0 : _g.style
      }, children: siweAuth.isLoggingIn ? (0, import_jsx_runtime96.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : (0, import_jsx_runtime96.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime96.jsx)(LockIcon, { size: iconSize.sm }), (0, import_jsx_runtime96.jsxs)("span", { children: [" ", ((_h = props.signInButton) == null ? void 0 : _h.label) || locale.signIn, " "] })] }) }), (0, import_jsx_runtime96.jsx)(Modal, { size: "compact", open: showSignatureModal, setOpen: setShowSignatureModal, children: (0, import_jsx_runtime96.jsx)(SignatureScreen, { client: props.client, connectLocale: locale, modalSize: "compact", termsOfServiceUrl: (_i = props.connectModal) == null ? void 0 : _i.termsOfServiceUrl, privacyPolicyUrl: (_j = props.connectModal) == null ? void 0 : _j.privacyPolicyUrl, onDone: () => setShowSignatureModal(false), auth: props.auth }) })] });
    }
  }
  return (0, import_jsx_runtime96.jsx)(AccountProvider, { address: activeAccount.address, client: props.client, children: (0, import_jsx_runtime96.jsx)(ConnectedWalletDetails, { theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
    var _a2;
    if (siweAuth.requiresAuth) {
      siweAuth.doLogout();
    }
...
function DirectPaymentModeScreen(props) {
  ...
  if (!chainData || totalCost === void 0) {
    return (0, import_jsx_runtime97.jsx)(LoadingScreen, {});
  }
  ...
  return (0, import_jsx_runtime97.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime97.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime97.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Payment Details" }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime97.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime97.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeWallet ? (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", center: "both", style: {
    padding: spacing.md,
    marginBottom: spacing.md,
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  }, children: [(0, import_jsx_runtime97.jsx)(WalletImage, { size: iconSize.xl, id: activeWallet.id, client }), (0, import_jsx_runtime97.jsx)("div", { style: {
    flexGrow: 1,
    borderBottom: "6px dotted",
    borderColor: theme.colors.secondaryIconColor,
    marginLeft: spacing.md,
    marginRight: spacing.md
  } }), (0, import_jsx_runtime97.jsx)(ChainIcon2, { client, size: iconSize.xl, chainIconUrl: (_e = chainData.icon) == null ? void 0 : _e.url })] }) : null, (0, import_jsx_runtime97.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime97.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime97.jsx)(Text, { size: "md", color: "primaryText", weight: 700, children: "Price" }) }), (0, import_jsx_runtime97.jsx)(Container, { expand: true, children: (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime97.jsx)(TokenIcon, { chain: paymentInfo.chain, client: props.client, size: "sm", token }), (0, import_jsx_runtime97.jsxs)(Text, { color: "primaryText", size: "md", weight: 700, children: [String(formatNumber(Number(totalCost), 6)), " ", token.symbol] })] }) })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime97.jsx)(Line, {}), (0, import_jsx_runtime97.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime97.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime97.jsx)(Text, { size: "xs", color: "secondaryText", children: "Network" }) }), (0, import_jsx_runtime97.jsx)(Container, { expand: true, children: (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime97.jsx)(ChainIcon2, { chainIconUrl: (_f = chainData.icon) == null ? void 0 : _f.url, size: "xs", client: props.client }), (0, import_jsx_runtime97.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: chainData.name })] }) })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime97.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime97.jsx)(Text, { size: "xs", color: "secondaryText", children: "Seller" }) }), (0, import_jsx_runtime97.jsx)(Container, { expand: true, children: (0, import_jsx_runtime97.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: (0, import_jsx_runtime97.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: sellerEns || shortenAddress(paymentInfo.sellerAddress) }) }) })] })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "xl" }), payerAccount ? (0, import_jsx_runtime97.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    var _a2;
    trackPayEvent({
  ...
  }, children: "Choose Payment Method" }) : (0, import_jsx_runtime97.jsx)("div", { children: (0, import_jsx_runtime97.jsx)(ConnectButton, { ...props.connectOptions, client, theme, connectButton: {
    style: {
      width: "100%"
    }
  } }) }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "lg" }), payUiOptions.showThirdwebBranding !== false && (0, import_jsx_runtime97.jsxs)(import_jsx_runtime97.Fragment, { children: [(0, import_jsx_runtime97.jsx)(PoweredByThirdweb, { link: "https://playground.thirdweb.com/connect/pay?utm_source=ub_text" }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "sm" })] })] });
}
...
function TransactionModeScreen(props) {
  ...
  if (!activeAccount) {
    return (0, import_jsx_runtime98.jsx)(Container, { style: {
      minHeight: "350px"
    }, fullHeight: true, flex: "row", center: "both", children: (0, import_jsx_runtime98.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime98.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime98.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime98.jsx)(OutlineWalletIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime98.jsx)(Text, { center: true, color: "primaryText", size: "md", children: "Please connect a wallet to continue" }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime98.jsx)(Container, { flex: "row", center: "x", style: { width: "100%" }, children: (0, import_jsx_runtime98.jsx)(ConnectButton, { client, theme, ...props.connectOptions }) })] }) });
  }
  if (transactionCostAndDataError || chainDataError) {
    return (0, import_jsx_runtime98.jsx)(Container, { style: {
      minHeight: "350px"
    }, fullHeight: true, flex: "row", center: "both", children: (0, import_jsx_runtime98.jsx)(ErrorState, { title: (transactionCostAndDataError == null ? void 0 : transactionCostAndDataError.message) || (chainDataError == null ? void 0 : chainDataError.message) || "Something went wrong", onTryAgain: transactionCostAndDataError ? transactionCostAndDataRefetch : chainDataRefetch }) });
  }
  ...
  return (0, import_jsx_runtime98.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime98.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Transaction" }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime98.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime98.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    border: `1px solid ${theme.colors.borderColor}`,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeAccount ? (0, import_jsx_runtime98.jsxs)(Container, { flex: "column", gap: "sm", children: [insufficientFunds && (0, import_jsx_runtime98.jsxs)("div", { children: [(0, import_jsx_runtime98.jsx)(Text, { color: "danger", size: "xs", center: true, multiline: true, children: "Insufficient Funds" }), (0, import_jsx_runtime98.jsx)(Text, { size: "xs", center: true, multiline: true, children: "Select another token or pay with card." })] }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between",
    padding: spacing.sm,
  ...
  } }) }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), payUiOptions.showThirdwebBranding !== false && (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [(0, import_jsx_runtime98.jsx)(PoweredByThirdweb, { link: "https://playground.thirdweb.com/connect/pay?utm_source=ub_text" }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "sm" })] })] });
}
...
function CurrencySelection(props) {
  return (0, import_jsx_runtime99.jsxs)(Container, { children: [(0, import_jsx_runtime99.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime99.jsx)(ModalHeader, { title: "Pay with", onBack: props.onBack }) }), (0, import_jsx_runtime99.jsx)(Line, {}), (0, import_jsx_runtime99.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime99.jsx)(Container, { flex: "column", gap: "xs", px: "lg", children: currencies.map((c) => {
    return (0, import_jsx_runtime99.jsxs)(SelectCurrencyButton, { fullWidth: true, variant: "secondary", onClick: () => props.onSelect(c), gap: "sm", children: [getFiatIcon(c, "lg"), (0, import_jsx_runtime99.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime99.jsx)(Text, { color: "primaryText", children: c.shorthand }), (0, import_jsx_runtime99.jsx)(Text, { size: "sm", children: c.name })] })] }, c.shorthand);
  }) }), (0, import_jsx_runtime99.jsx)(Spacer, { y: "lg" })] });
}
...
var Drawer = (0, import_react53.forwardRef)(function Drawer_(props, ref) {
  return (0, import_jsx_runtime100.jsx)(DrawerContainer, { ref, children: (0, import_jsx_runtime100.jsx)(DynamicHeight, { children: (0, import_jsx_runtime100.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime100.jsx)(CrossContainer, { children: (0, import_jsx_runtime100.jsx)(IconButton, { type: "button", "aria-label": "Close", onClick: props.close, children: (0, import_jsx_runtime100.jsx)(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
    color: "inherit"
  } }) }) }), props.children] }) }) });
});
...
function useDrawer() {
  const [isOpen, _setIsOpen] = (0, import_react53.useState)(false);
  const drawerRef = (0, import_react53.useRef)(null);
  const drawerOverlayRef = (0, import_react53.useRef)(null);
  const closeDrawerAnimation = (0, import_react53.useCallback)(() => {
  ...
  const setIsOpen = (0, import_react53.useCallback)(async (value) => {
    if (value) {
      _setIsOpen(true);
    } else {
...
function EstimatedTimeAndFees(props) {
  ...
  return (0, import_jsx_runtime101.jsxs)(Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
    borderRadius: radius.md,
    ...
    borderWidth: "1px",
    borderStyle: "solid"
  }, children: [(0, import_jsx_runtime101.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "accentText", p: "sm", children: [(0, import_jsx_runtime101.jsx)(ClockIcon, { width: iconSize.sm, height: iconSize.sm }), quoteIsLoading ? (0, import_jsx_runtime101.jsx)(Skeleton, { height: fontSize.xs, width: "50px", color: "borderColor" }) : (0, import_jsx_runtime101.jsx)(Text, { size: "xs", color: "secondaryText", children: estimatedSeconds !== void 0 ? `~${formatSeconds(estimatedSeconds)}` : "--" })] }), (0, import_jsx_runtime101.jsxs)(Button, { variant: "ghost", onClick: props.onViewFees, gap: "xs", children: [(0, import_jsx_runtime101.jsx)(Container, { color: "accentText", flex: "row", center: "both", children: (0, import_jsx_runtime101.jsx)(ViewFeeIcon, { size: iconSize.sm }) }), (0, import_jsx_runtime101.jsx)(Text, { size: "xs", color: "secondaryText", children: "View Fees" })] })] });
}
var ViewFeeIcon = (props) => {
  return (0, import_jsx_runtime101.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [(0, import_jsx_runtime101.jsx)("path", { d: "M9.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V9.5C1.5 10.0523 1.94772 10.5 2.5 10.5H9.5C10.0523 10.5 10.5 10.0523 10.5 9.5V2.5C10.5 1.94772 10.0523 1.5 9.5 1.5Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime101.jsx)("path", { d: "M4.5 7.5L7.5 4.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function PayWithCreditCard(props) {
  return (0, import_jsx_runtime102.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    borderRadius: radius.md,
    borderBottomRightRadius: 0,
    borderBottomLeftRadius: 0,
    borderWidth: "1px",
    ...
    justifyContent: "space-between",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime102.jsxs)(CurrencyButton, { variant: "ghost", onClick: props.onSelectCurrency, style: {
    minHeight: "64px",
    justifyContent: "flex-start",
    minWidth: "50%"
  }, gap: "sm", children: [getFiatIcon(props.currency, "md"), (0, import_jsx_runtime102.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "secondaryText", children: [(0, import_jsx_runtime102.jsx)(Text, { color: "primaryText", children: props.currency.shorthand }), (0, import_jsx_runtime102.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] })] }), (0, import_jsx_runtime102.jsx)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
  ...
  }, children: props.isLoading ? (0, import_jsx_runtime102.jsx)(Skeleton, { width: "100px", height: fontSize.lg }) : (0, import_jsx_runtime102.jsx)(Text, { size: "lg", color: props.value ? "primaryText" : "secondaryText", children: props.value ? `${props.currency.symbol}${formatNumber(Number(props.value), 6)}` : "--" }) })] });
}
...
function SwapFees(props) {
  return (0, import_jsx_runtime103.jsx)(Container, { flex: "column", gap: "xs", style: {
    alignItems: "flex-start"
  }, children: props.quote.processingFees.map((fee) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime103.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime103.jsxs)(Text, { color: "primaryText", size: "sm", children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime103.jsxs)(Text, { color: "secondaryText", size: "sm", children: ["($", (fee.amountUSDCents / 100).toFixed(2), ")"] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
function FiatFees(props) {
  return (0, import_jsx_runtime103.jsxs)(Container, { flex: "column", gap: "xs", children: [(0, import_jsx_runtime103.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime103.jsx)(Text, { inline: true, color: "secondaryText", children: "Amount" }), (0, import_jsx_runtime103.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrency.amount), 2), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime103.jsxs)("div", { style: {
      display: "flex",
      justifyContent: "space-between"
    }, children: [(0, import_jsx_runtime103.jsx)(Text, { inline: true, color: "secondaryText", children: fee.feeType === "NETWORK" ? "Network Fee" : "Processing Fee" }), (0, import_jsx_runtime103.jsxs)(Text, { color: "primaryText", inline: true, children: [feeAmount === 0 ? "~" : "", " ", feeAmount, " ", fee.currencySymbol] })] }, i);
  }), (0, import_jsx_runtime103.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime103.jsx)(Line, {}), (0, import_jsx_runtime103.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime103.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime103.jsx)(Text, { inline: true, color: "secondaryText", children: "Total" }), (0, import_jsx_runtime103.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrencyWithFees.amount), 6), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] });
}
...
var FiatProviders = ["COINBASE", "STRIPE", "TRANSAK", "KADO"];

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/Providers.js
function Providers(props) {
  return (0, import_jsx_runtime104.jsx)(Container, { expand: true, flex: "column", gap: "sm", style: {
    alignItems: "flex-start"
  }, children: FiatProviders.map((provider) => {
    return (0, import_jsx_runtime104.jsx)(Container, { flex: "row", expand: true, style: {
      justifyContent: "space-between"
    }, children: (0, import_jsx_runtime104.jsx)(Button, { fullWidth: true, onClick: () => props.onSelect(provider), variant: "link", children: (0, import_jsx_runtime104.jsx)(Link, { color: props.preferredProvider === provider ? "primaryText" : "secondaryText", size: "sm", hoverColor: "primaryText", children: provider.charAt(0).toUpperCase() + provider.slice(1).toLowerCase() }) }) }, provider);
  }) });
}
...
function FiatScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react54.useState)("fees");
  const buyWithFiatOptions = props.payOptions.buyWithFiat;
  const [preferredProvider, setPreferredProvider] = (0, import_react54.useState)(buyWithFiatOptions !== false ? (buyWithFiatOptions == null ? void 0 : buyWithFiatOptions.preferredProvider) || (localStorage.getItem(PREFERRED_FIAT_PROVIDER_STORAGE_KEY) ?? void 0) : void 0);
  ...
  return (0, import_jsx_runtime105.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", children: [isOpen && (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: [(0, import_jsx_runtime105.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime105.jsxs)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: [drawerScreen === "fees" && fiatQuoteQuery.data && (0, import_jsx_runtime105.jsxs)("div", { children: [(0, import_jsx_runtime105.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime105.jsx)(FiatFees, { quote: fiatQuoteQuery.data })] }), drawerScreen === "providers" && (0, import_jsx_runtime105.jsxs)("div", { children: [(0, import_jsx_runtime105.jsx)(Text, { size: "lg", color: "primaryText", children: "Providers" }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime105.jsx)(Providers, { preferredProvider: preferredProvider || ((_c = fiatQuoteQuery.data) == null ? void 0 : _c.provider), onSelect: (provider) => {
    setPreferredProvider(provider);
    localStorage.setItem(PREFERRED_FIAT_PROVIDER_STORAGE_KEY, provider);
    setIsOpen(false);
  } })] })] })] }), (0, import_jsx_runtime105.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime105.jsx)(Text, { size: "sm", children: "Pay with card" }), (0, import_jsx_runtime105.jsxs)("div", { children: [(0, import_jsx_runtime105.jsx)(PayWithCreditCard, { isLoading: fiatQuoteQuery.isLoading, value: (_d = fiatQuoteQuery.data) == null ? void 0 : _d.fromCurrencyWithFees.amount, client, currency: selectedCurrency, onSelectCurrency: showCurrencySelector }), (0, import_jsx_runtime105.jsxs)(Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
    ...
    borderStyle: "solid",
    borderBottom: "none"
  }, children: [(0, import_jsx_runtime105.jsx)(Text, { size: "xs", color: "secondaryText", children: "Provider" }), (0, import_jsx_runtime105.jsx)(Button, { variant: "ghost", onClick: showProviders, children: (0, import_jsx_runtime105.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "secondaryText", children: [(0, import_jsx_runtime105.jsx)(Text, { size: "xs", children: preferredProvider ? `${preferredProvider.charAt(0).toUpperCase() + preferredProvider.slice(1).toLowerCase()}` : ((_e = fiatQuoteQuery.data) == null ? void 0 : _e.provider) ? `${((_f = fiatQuoteQuery.data) == null ? void 0 : _f.provider.charAt(0).toUpperCase()) + ((_g = fiatQuoteQuery.data) == null ? void 0 : _g.provider.slice(1).toLowerCase())}` : "" }), (0, import_jsx_runtime105.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] }) })] }), (0, import_jsx_runtime105.jsx)(EstimatedTimeAndFees, { quoteIsLoading: fiatQuoteQuery.isLoading, estimatedSeconds: (_h = fiatQuoteQuery.data) == null ? void 0 : _h.estimatedDurationSeconds, onViewFees: showFees })] }), errorMsg && (0, import_jsx_runtime105.jsx)("div", { children: ((_i = errorMsg.data) == null ? void 0 : _i.minimumAmountEth) ? (0, import_jsx_runtime105.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is", " ", formatNumber(Number(errorMsg.data.minimumAmountEth), 6), " ", (0, import_jsx_runtime105.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }) : (0, import_jsx_runtime105.jsxs)("div", { children: [(0, import_jsx_runtime105.jsx)(Text, { color: "danger", size: "xs", center: true, multiline: true, children: errorMsg.title }), (0, import_jsx_runtime105.jsx)(Text, { size: "xs", center: true, multiline: true, children: errorMsg.message })] }) })] }), ((_j = errorMsg == null ? void 0 : errorMsg.data) == null ? void 0 : _j.minimumAmountEth) ? (0, import_jsx_runtime105.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    var _a2;
    props.setTokenAmount(formatNumber(Number((_a2 = errorMsg.data) == null ? void 0 : _a2.minimumAmountEth), 6).toString());
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : (0, import_jsx_runtime105.jsx)(Button, { variant: disableSubmit ? "outline" : "accent", "data-disabled": disableSubmit, disabled: disableSubmit, fullWidth: true, onClick: () => {
    trackPayEvent({
    ...
    handleSubmit();
  }, gap: "xs", children: fiatQuoteQuery.isLoading ? (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime105.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
...
function OnRampScreen(props) {
  ...
  return (0, import_jsx_runtime106.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime106.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime106.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime106.jsx)(Container, { flex: "column", gap: "xs", center: "y", style: {
    paddingLeft: spacing.md
  }, children: (0, import_jsx_runtime106.jsx)(WalletRow, { client: props.client, address: props.receiverAddress, iconSize: "md", textSize: "sm", label: "Recipient wallet" }) }), (0, import_jsx_runtime106.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime106.jsx)(Container, { flex: "column", children: state.steps.map(({ step, status }, index2) => (0, import_jsx_runtime106.jsxs)(Container, { flex: "column", children: [(0, import_jsx_runtime106.jsx)(StepContainer, { state: status, index: index2, style: {
    flex: "1"
  }, children: (0, import_jsx_runtime106.jsx)(StepUI, { step, client: props.client, payer: props.payer, index: index2 }) }), index2 < state.steps.length - 1 && (0, import_jsx_runtime106.jsx)(StepConnectorArrow, {})] }, step.action)) }), (0, import_jsx_runtime106.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime106.jsx)(Text, { size: "xs", color: "secondaryText", center: true, style: { padding: `0 ${spacing.xl}` }, children: "Keep this window open until all transactions are complete." }), (0, import_jsx_runtime106.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime106.jsx)(Container, { flex: "column", gap: "md", children: !state.isDone && firstStepChainId && firstStepChainId !== props.payer.chain.id ? (0, import_jsx_runtime106.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(getCachedChain(firstStepChainId));
  } }) : (0, import_jsx_runtime106.jsxs)(Button, { variant: "accent", gap: "sm", fullWidth: true, onClick: state.handleContinue, disabled: state.isLoading, children: [state.isLoading ? "Processing" : state.isDone ? props.transactionMode ? "Continue Transaction" : "Done" : state.isFailed ? "Retry" : "Continue", state.isLoading && (0, import_jsx_runtime106.jsx)(Spinner, { size: "sm", color: "primaryText" })] }) })] });
}
function StepUI(props) {
  const { step, client } = props;
  const chain = useChainName(getCachedChain(step.token.chainId));
  return (0, import_jsx_runtime106.jsx)(Container, { flex: "column", gap: "xs", py: "3xs", children: (0, import_jsx_runtime106.jsxs)(Container, { flex: "row", center: "y", gap: "sm", style: {
    display: "flex",
    justifyContent: "space-between",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime106.jsx)(PayTokenIcon, { chain: getCachedChain(step.token.chainId), client, size: "md", token: {
    address: step.token.tokenAddress
  } }), (0, import_jsx_runtime106.jsxs)(Container, { flex: "column", gap: "3xs", center: "y", style: { flex: "1" }, children: [(0, import_jsx_runtime106.jsx)(Text, { size: "sm", color: "primaryText", children: step.action.charAt(0).toUpperCase() + step.action.slice(1) }), (0, import_jsx_runtime106.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: {
    display: "flex",
    justifyContent: "space-between",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime106.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", style: {
    flex: "1 1 60%",
    minWidth: 0,
    maxWidth: "60%",
    overflow: "hidden",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime106.jsx)(Text, { size: "sm", color: "primaryText", children: formatNumber(Number(step.amount), 5) }), (0, import_jsx_runtime106.jsx)(TokenSymbol, { token: {
    address: step.token.tokenAddress,
    name: step.token.name || "",
    symbol: step.token.symbol || ""
  }, chain: getCachedChain(step.token.chainId), size: "sm", color: "secondaryText" })] }), (0, import_jsx_runtime106.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
    flex: "1 1 40%",
    maxWidth: "40%",
    minWidth: 0,
    justifyContent: "flex-end",
    flexWrap: "nowrap"
  }, children: (0, import_jsx_runtime106.jsx)(Text, { size: "xs", style: {
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap"
  }, children: chain.name }) })] })] })] }) });
...
function useOnRampScreenState(props) {
  ...
  const [swapTxHash, setSwapTxHash] = (0, import_react55.useState)();
  const [popupWindow, setPopupWindow] = (0, import_react55.useState)(null);
  ...
  const handleContinue = (0, import_react55.useCallback)(async () => {
    if (isDone) {
      props.onDone();
      return;
    }
...
function useSwapStatus(props) {
  ...
  const queryClient = useQueryClient();
  const balanceInvalidated = (0, import_react55.useRef)(false);
  (0, import_react55.useEffect)(() => {
...
function FiatValue(props) {
  ...
  if (cryptoToFiatQuery.isLoading) {
    return (0, import_jsx_runtime107.jsx)(Skeleton, { width: "50px", height: fontSize.lg });
  }
  return ((_a = cryptoToFiatQuery.data) == null ? void 0 : _a.result) ? (0, import_jsx_runtime107.jsxs)(Text, { ...props, children: ["$", formatNumber(cryptoToFiatQuery.data.result, 2).toFixed(2)] }) : null;
}
...
function BuyTokenInput(props) {
  ...
  return (0, import_jsx_runtime108.jsxs)(Container, { children: [(0, import_jsx_runtime108.jsx)("div", { onClick: (e) => {
    var _a;
    (_a = e.currentTarget.querySelector("input")) == null ? void 0 : _a.focus();
  }, children: (0, import_jsx_runtime108.jsxs)(Container, { flex: "row", center: "both", gap: "xs", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime108.jsx)(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", tabIndex: -1, placeholder: "0", type: "text", "data-placeholder": props.value === "", value: props.value || "0", disabled: props.freezeAmount, onClick: (e) => {
    if (props.value === "") {
  ...
  } }), (0, import_jsx_runtime108.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "lg", color: "secondaryText" })] }) }), (0, import_jsx_runtime108.jsx)(Container, { flex: "row", center: "both", style: {
    height: fontSize.xl
  }, children: (0, import_jsx_runtime108.jsx)(FiatValue, { tokenAmount: props.value, token: props.token, chain: props.chain, client: props.client, size: "md" }) }), !props.hideTokenSelector && (0, import_jsx_runtime108.jsxs)(import_jsx_runtime108.Fragment, { children: [(0, import_jsx_runtime108.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime108.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime108.jsx)(TokenRow, { token: props.token, chain: props.chain, client: props.client, onSelectToken: props.onSelectToken, freezeChainAndToken: props.freezeChainAndToken }) })] })] });
}
...
function PayWithCryptoQuoteInfo(props) {
  ...
  return (0, import_jsx_runtime109.jsxs)(Container, { bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    ...props.swapRequired ? {
      borderBottom: "none",
  ...
  }, children: [(0, import_jsx_runtime109.jsxs)(Container, { flex: "row", gap: "sm", style: {
    justifyContent: "space-between",
    padding: spacing.sm,
    borderBottom: `1px solid ${theme.colors.borderColor}`
  }, children: [(0, import_jsx_runtime109.jsx)(WalletRow, { client: props.client, address: props.payerAccount.address }), props.token && props.chain && balanceQuery.data ? (0, import_jsx_runtime109.jsxs)(Container, { flex: "row", gap: "3xs", center: "y", children: [(0, import_jsx_runtime109.jsx)(Text, { size: "xs", color: "secondaryText", weight: 500, children: formatTokenBalance(balanceQuery.data, false, 4) }), (0, import_jsx_runtime109.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "xs", color: "secondaryText" })] }) : props.token && props.chain && balanceQuery.isLoading ? (0, import_jsx_runtime109.jsx)(Skeleton, { width: "70px", height: fontSize.xs }) : null] }), (0, import_jsx_runtime109.jsx)(TokenRow, { token: props.token, chain: props.chain, client: props.client, isLoading: props.isLoading, value: props.value, onSelectToken: props.onSelectToken, style: {
    border: "none",
    borderRadius: 0,
...
function SwapScreenContent(props) {
  ...
  const { drawerRef, drawerOverlayRef, isOpen, setIsOpen } = useDrawer();
  const [drawerScreen, setDrawerScreen] = (0, import_react57.useState)("fees");
  ...
  const allowanceQuery = useQuery({
    queryKey: [
      ...
      (_d = quoteQuery.data) == null ? void 0 : _d.approvalData
    ],
    queryFn: () => {
      var _a2;
    ...
    enabled: !!((_e = quoteQuery.data) == null ? void 0 : _e.approvalData),
    refetchOnMount: true
  });
  ...
  const switchChainRequired = ((_g = props.payer.wallet.getChain()) == null ? void 0 : _g.id) !== (fromChain == null ? void 0 : fromChain.id);
  ...
  return (0, import_jsx_runtime110.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", children: [isOpen && (0, import_jsx_runtime110.jsxs)(import_jsx_runtime110.Fragment, { children: [(0, import_jsx_runtime110.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime110.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && quoteQuery.data && (0, import_jsx_runtime110.jsxs)("div", { children: [(0, import_jsx_runtime110.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime110.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime110.jsx)(SwapFees, { quote: quoteQuery.data })] }) })] }), (0, import_jsx_runtime110.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime110.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime110.jsx)(Text, { size: "sm", children: "Pay with" }), fromToken && fromChain ? (0, import_jsx_runtime110.jsx)(TokenSymbol, { token: fromToken, chain: fromChain, size: "sm", color: "secondaryText" }) : "crypto"] }), (0, import_jsx_runtime110.jsxs)("div", { children: [(0, import_jsx_runtime110.jsx)(PayWithCryptoQuoteInfo, { value: sourceTokenAmount || "", chain: fromChain, token: fromToken, isLoading: quoteQuery.isLoading && !sourceTokenAmount, client, freezeChainAndTokenSelection: disableTokenSelection, payerAccount: props.payer.account, swapRequired, onSelectToken: props.showFromTokenSelector }), swapRequired && fromChain && fromToken && (0, import_jsx_runtime110.jsx)(EstimatedTimeAndFees, { quoteIsLoading: quoteQuery.isLoading, estimatedSeconds: (_h = quoteQuery.data) == null ? void 0 : _h.swapDetails.estimated.durationSeconds, onViewFees: showFees })] }), errorMsg && (0, import_jsx_runtime110.jsx)("div", { children: ((_i = errorMsg.data) == null ? void 0 : _i.minimumAmountEth) ? (0, import_jsx_runtime110.jsxs)(Text, { color: "danger", size: "xs", center: true, multiline: true, children: ["Minimum amount is", " ", formatNumber(Number(errorMsg.data.minimumAmountEth), 6), " ", (0, import_jsx_runtime110.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }) : (0, import_jsx_runtime110.jsxs)("div", { children: [(0, import_jsx_runtime110.jsx)(Text, { color: "danger", size: "xs", center: true, multiline: true, children: errorMsg.title }), (0, import_jsx_runtime110.jsx)(Text, { size: "xs", center: true, multiline: true, children: errorMsg.message })] }) }), !errorMsg && isNotEnoughBalance && (0, import_jsx_runtime110.jsxs)("div", { children: [(0, import_jsx_runtime110.jsx)(Text, { color: "danger", size: "xs", center: true, multiline: true, children: "Insufficient Funds" }), (0, import_jsx_runtime110.jsx)(Text, { size: "xs", center: true, multiline: true, children: "Select another token or pay with card." })] })] }), ((_j = errorMsg == null ? void 0 : errorMsg.data) == null ? void 0 : _j.minimumAmountEth) ? (0, import_jsx_runtime110.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    var _a2;
    props.setTokenAmount(formatNumber(Number((_a2 = errorMsg.data) == null ? void 0 : _a2.minimumAmountEth), 6).toString());
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : isNotEnoughBalance || errorMsg ? (0, import_jsx_runtime110.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => props.showFromTokenSelector(), children: "Pay with another token" }) : switchChainRequired && fromChain && !quoteQuery.isLoading && !allowanceQuery.isLoading && !isNotEnoughBalance && !quoteQuery.error ? (0, import_jsx_runtime110.jsx)(SwitchNetworkButton, { variant: "accent", fullWidth: true, switchChain: async () => {
    await props.payer.wallet.switchChain(fromChain);
  } }) : (0, import_jsx_runtime110.jsx)(Button, { variant: disableContinue ? "outline" : "accent", fullWidth: true, "data-disabled": disableContinue, disabled: disableContinue, onClick: async () => {
    if (!disableContinue) {
      showSwapFlow();
      trackPayEvent({
  ...
  }, gap: "xs", children: quoteQuery.isLoading ? (0, import_jsx_runtime110.jsxs)(import_jsx_runtime110.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime110.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
...
async function fetchBalancesForWallet({ wallet, accountAddress, sourceSupportedTokens, toChain, toToken, tokenAmount, mode, client }) {
  var _a, _b, _c;
  const account = wallet.getAccount();
  if (!account) {
    return [];
  ...
  const destinationToken = isNativeToken(toToken) ? {
    address: NATIVE_TOKEN_ADDRESS,
    name: ((_a = toChain.nativeCurrency) == null ? void 0 : _a.name) || "",
    symbol: ((_b = toChain.nativeCurrency) == null ? void 0 : _b.symbol) || "",
    icon: (_c = toChain.icon) == null ? void 0 : _c.url
  } : toToken;
  const tokenMap = {
    ...
    for (const token of tokens) {
      ...
      rpcCalls.push((async () => {
        try {
          ...
          const include = token.address === destinationToken.address && chain.id === toChain.id ? mode === "fund_wallet" && account.address === accountAddress ? false : Number(balance.displayValue) > Number(tokenAmount) : balance.value > 0n;
          if (include) {
...
function TokenSelectorScreen(props) {
    ...
    queryFn: async () => {
      const entries = await Promise.all(connectedWallets.map(async (wallet) => {
        ...
        return [
          {
            id: wallet.id,
            address: ((_a2 = wallet.getAccount()) == null ? void 0 : _a2.address) || ""
          },
          balances
        ];
      }));
  ...
  if (walletsAndBalances.isLoading || chainInfo.isLoading || !chainInfo.data || !props.sourceSupportedTokens) {
    return (0, import_jsx_runtime111.jsx)(LoadingScreen, {});
  }
  ...
  return (0, import_jsx_runtime111.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "200px"
  }, children: [filteredWallets.length === 0 ? (0, import_jsx_runtime111.jsx)(Container, { flex: "column", gap: "xs", py: "lg", children: (0, import_jsx_runtime111.jsxs)(Text, { size: "xs", color: "secondaryText", center: true, children: ["No suitable payment token found", (0, import_jsx_runtime111.jsx)("br", {}), "in connected wallets"] }) }) : (0, import_jsx_runtime111.jsxs)(Container, { flex: "column", gap: "xs", children: [(0, import_jsx_runtime111.jsx)(Text, { size: "sm", children: "Select payment token" }), (0, import_jsx_runtime111.jsx)(Spacer, { y: "xs" })] }), (0, import_jsx_runtime111.jsx)(Container, { scrollY: true, style: {
    maxHeight: "350px"
  }, children: (0, import_jsx_runtime111.jsxs)(Container, { flex: "column", gap: "sm", children: [filteredWallets.map(([w, balances]) => {
    ...
    if (!wallet)
      return null;
    return (0, import_jsx_runtime111.jsx)(WalletRowWithBalances, { wallet, balances, client: props.client, address, onClick: (wallet2, token, chain) => {
      trackPayEvent({
  ...
  }), filteredWallets.length > 0 && (0, import_jsx_runtime111.jsx)(TextDivider, { text: "OR" }), (0, import_jsx_runtime111.jsx)(Button, { variant: "secondary", fullWidth: true, onClick: () => {
    trackPayEvent({
    ...
    border: `1px solid ${theme.colors.borderColor}`,
    padding: spacing.sm
  }, children: (0, import_jsx_runtime111.jsxs)(Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [(0, import_jsx_runtime111.jsx)(OutlineWalletIcon, { size: iconSize.md }), (0, import_jsx_runtime111.jsx)(Text, { size: "sm", color: "primaryText", children: "Pay with another wallet" })] }) }), props.fiatSupported && (0, import_jsx_runtime111.jsx)(Button, { variant: "secondary", fullWidth: true, onClick: () => {
    trackPayEvent({
    ...
    border: `1px solid ${theme.colors.borderColor}`,
    padding: spacing.sm
  }, children: (0, import_jsx_runtime111.jsxs)(Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [(0, import_jsx_runtime111.jsx)(CardStackIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime111.jsx)(Text, { size: "sm", color: "primaryText", children: "Pay with card" })] }) })] }) })] });
}
function WalletRowWithBalances(props) {
  ...
  return (0, import_jsx_runtime111.jsxs)(Container, { flex: "column", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`
  }, children: [(0, import_jsx_runtime111.jsxs)(Container, { flex: "row", gap: "sm", bg: "tertiaryBg", style: {
    justifyContent: "space-between",
    ...
    borderBottom: `1px solid ${theme.colors.borderColor}`
  }, children: [(0, import_jsx_runtime111.jsx)(WalletRow, { ...props }), !isActiveAccount && (0, import_jsx_runtime111.jsx)(Button, { variant: "ghost", onClick: () => disconnect(props.wallet), style: {
    padding: spacing.xxs,
    color: theme.colors.secondaryText
  }, children: (0, import_jsx_runtime111.jsx)(Cross2Icon, { width: iconSize.sm, height: iconSize.sm }) })] }), (0, import_jsx_runtime111.jsx)(Container, { flex: "column", children: props.balances.length > 0 ? displayedBalances.map((b, idx) => (0, import_jsx_runtime111.jsx)(TokenBalanceRow, { client: props.client, onClick: () => props.onClick(props.wallet, b.token, b.chain), tokenBalance: b, wallet: props.wallet, style: {
    borderTopLeftRadius: 0,
    borderTopRightRadius: 0,
  ...
  } }, `${b.token.address}-${b.chain.id}`)) : (0, import_jsx_runtime111.jsx)(Container, { style: { padding: spacing.sm }, children: (0, import_jsx_runtime111.jsx)(Text, { size: "sm", color: "secondaryText", children: "Insufficient Funds" }) }) })] });
}
function TokenBalanceRow(props) {
  ...
  return (0, import_jsx_runtime111.jsxs)(StyledButton2, { onClick: () => onClick(tokenBalance.token, wallet), variant: "secondary", style: {
    ...style,
    display: "flex",
    justifyContent: "space-between",
    minWidth: 0
    // Needed for text truncation to work
  }, children: [(0, import_jsx_runtime111.jsxs)(Container, { flex: "row", center: "y", gap: "sm", style: {
    flex: "1 1 50%",
    minWidth: 0,
    maxWidth: "50%",
    overflow: "hidden",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime111.jsx)(TokenIcon, { token: tokenBalance.token, chain: tokenBalance.chain, size: "md", client }), (0, import_jsx_runtime111.jsxs)(Container, { flex: "column", gap: "4xs", style: { minWidth: 0 }, children: [(0, import_jsx_runtime111.jsx)(Text, { size: "xs", color: "primaryText", style: {
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap"
  }, children: tokenBalance.token.symbol }), chainInfo && (0, import_jsx_runtime111.jsx)(Text, { size: "xs", style: {
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap"
  }, children: chainInfo.name })] })] }), (0, import_jsx_runtime111.jsxs)(Container, { flex: "row", center: "y", gap: "4xs", color: "secondaryText", style: {
    flex: "1 1 50%",
    maxWidth: "50%",
    minWidth: 0,
    justifyContent: "flex-end",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime111.jsxs)(Container, { flex: "column", color: "secondaryText", gap: "4xs", style: {
    alignItems: "flex-end",
    minWidth: 0,
    overflow: "hidden"
  }, children: [(0, import_jsx_runtime111.jsx)(Text, { size: "xs", color: "primaryText", style: {
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap"
  }, children: formatTokenBalance(tokenBalance.balance, true, 2) }), (0, import_jsx_runtime111.jsx)(FiatValue, { tokenAmount: tokenBalance.balance.displayValue, token: tokenBalance.token, chain: tokenBalance.chain, client, size: "xs" })] }), (0, import_jsx_runtime111.jsx)(ChevronRightIcon, { width: iconSize.md, height: iconSize.md, style: { flexShrink: 0 } })] })] });
}
...
function TransferConfirmationScreen(props) {
  ...
  const uiErrorMessage = (0, import_react58.useMemo)(() => {
    if (step === "approve" && status.id === "error" && status.error) {
      if (status.error.toLowerCase().includes("user rejected") || status.error.toLowerCase().includes("user closed modal") || status.error.toLowerCase().includes("user denied")) {
        return {
          title: "Failed to Approve",
          message: "Your wallet rejected the approval request."
        };
  ...
  if (transferQuery.isLoading) {
    return (0, import_jsx_runtime112.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime112.jsx)(ModalHeader, { title, onBack }), (0, import_jsx_runtime112.jsxs)(Container, { flex: "column", center: "both", style: { minHeight: "300px" }, children: [(0, import_jsx_runtime112.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime112.jsx)(Spinner, { size: "xl", color: "secondaryText" }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "xl" })] })] });
  }
  const transferFromAmountWithFees = ((_a = transferQuery.data) == null ? void 0 : _a.paymentToken.amount) || tokenAmount;
  return (0, import_jsx_runtime112.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime112.jsx)(ModalHeader, { title, onBack }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "xl" }), transactionMode ? (0, import_jsx_runtime112.jsxs)(import_jsx_runtime112.Fragment, { children: [(0, import_jsx_runtime112.jsx)(StepBar, { steps: 2, currentStep: step === "transfer" ? 1 : 2 }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime112.jsx)(Text, { size: "sm", children: step === "transfer" ? "Step 1 of 2 - Transfer funds" : "Step 2 of 2 - Finalize transaction" }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "md" })] }) : (0, import_jsx_runtime112.jsxs)(import_jsx_runtime112.Fragment, { children: [(0, import_jsx_runtime112.jsx)(Text, { size: "sm", children: "Confirm payment" }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "md" })] }), (0, import_jsx_runtime112.jsx)(SwapSummary, { sender: payer.account.address, receiver: receiverAddress, client, fromToken: token, fromChain: chain, toToken: token, toChain: chain, fromAmount: transactionMode ? tokenAmount : transferFromAmountWithFees, toAmount: tokenAmount }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "lg" }), transactionMode && (0, import_jsx_runtime112.jsxs)(import_jsx_runtime112.Fragment, { children: [(0, import_jsx_runtime112.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime112.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime112.jsx)(Step, { isDone: step === "execute", isActive: step === "transfer", label: step === "transfer" ? "Transfer" : "Done" }), (0, import_jsx_runtime112.jsx)(ConnectorLine, {}), (0, import_jsx_runtime112.jsx)(Step, { isDone: false, label: "Finalize", isActive: step === "execute" })] }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "lg" })] }), uiErrorMessage && (0, import_jsx_runtime112.jsxs)(import_jsx_runtime112.Fragment, { children: [(0, import_jsx_runtime112.jsx)(ErrorText, { title: uiErrorMessage.title, message: uiErrorMessage.message }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "md" })] }), !transactionMode && step === "execute" && status.id === "done" && (0, import_jsx_runtime112.jsxs)(import_jsx_runtime112.Fragment, { children: [(0, import_jsx_runtime112.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "success", children: [(0, import_jsx_runtime112.jsx)(CheckCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime112.jsx)(Text, { color: "success", size: "sm", children: "Payment completed" })] }), (0, import_jsx_runtime112.jsx)(Spacer, { y: "md" })] }), payer.chain.id !== chain.id ? (0, import_jsx_runtime112.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(chain);
  } }) : (0, import_jsx_runtime112.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status.id === "pending", onClick: async () => {
    var _a2, _b;
    if (step === "execute") {
      onDone();
      return;
  ...
  }, gap: "xs", children: [step === "execute" && (status.id === "done" ? "Done" : "Continue"), step === "transfer" && (status.id === "pending" ? "Confirming" : "Confirm"), step === "approve" && (status.id === "pending" ? "Approving" : "Approve"), status.id === "pending" && (0, import_jsx_runtime112.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}
...
function TransferFlow(props) {
  ...
  if (transferTxHash) {
    return (0, import_jsx_runtime113.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash: transferTxHash, fromChain: props.chain, client: props.client, onDone: props.onDone, transactionMode: false, isEmbed: props.isEmbed, quote: void 0, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime113.jsx)(TransferConfirmationScreen, { ...props, setTransactionHash: setTransferTxHash });
}
...
function BuyScreen2(props) {
  ...
  if (supportedDestinationsQuery.isError) {
    return (0, import_jsx_runtime114.jsx)(Container, { style: {
      minHeight: "350px"
    }, fullHeight: true, flex: "row", center: "both", children: (0, import_jsx_runtime114.jsx)(ErrorState, { title: "Something went wrong", onTryAgain: supportedDestinationsQuery.refetch }) });
  }
  if (!supportedDestinationsQuery.data) {
    return (0, import_jsx_runtime114.jsx)(LoadingScreen, {});
  }
  ...
  return (0, import_jsx_runtime114.jsx)(BuyScreenContent, { ...props, supportedDestinations });
}
function BuyScreenContent(props) {
  ...
  if (screen.id === "swap-flow" && payer) {
    return (0, import_jsx_runtime114.jsx)(SwapFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", isEmbed: props.isEmbed, client, onBack: () => {
      setScreen({
        id: "buy-with-crypto"
      });
  ...
  if (screen.id === "fiat-flow" && payer) {
    ...
    return (0, import_jsx_runtime114.jsx)(OnRampScreen, { title: props.title, transactionMode: payOptions.mode === "transaction", quote: screen.quote, onBack: () => {
      setScreen({
        id: "buy-with-fiat"
      });
    }, client, testMode: props.payOptions.buyWithFiat !== false && ((_m = props.payOptions.buyWithFiat) == null ? void 0 : _m.testMode) === true, theme: typeof props.theme === "string" ? props.theme : props.theme.type, onDone, isEmbed: props.isEmbed, payer, receiverAddress, onSuccess: onFiatSuccess });
  }
  if (screen.id === "transfer-flow" && payer && activeAccount) {
    ...
    return (0, import_jsx_runtime114.jsx)(TransferFlow, { title: props.title, onBack: goBack, payer, client: props.client, chain: toChain, token: toToken, tokenAmount, receiverAddress, transactionMode: props.payOptions.mode === "transaction", payOptions, isEmbed: props.isEmbed, onDone, onTryAgain: () => {
      setScreen({
        id: "buy-with-crypto"
      });
  ...
  if (screen.id === "select-currency") {
    ...
    return (0, import_jsx_runtime114.jsx)(CurrencySelection, { onSelect: (currency) => {
      goBack();
  ...
  if (screen.id === "select-to-token") {
    ...
    if ((allowEdits == null ? void 0 : allowEdits.token) === false) {
      return (0, import_jsx_runtime114.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setToChain, goBack });
    }
    return (0, import_jsx_runtime114.jsx)(TokenSelector, { onBack: goBack, tokenList: (((toChain == null ? void 0 : toChain.id) ? destinationSupportedTokens[toChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
  ...
  }, children: [screen.id === "buy-with-crypto" && activeAccount && (0, import_jsx_runtime114.jsx)(SwapScreenContent, {
    setScreen,
  ...
  }), screen.id === "buy-with-fiat" && (0, import_jsx_runtime114.jsx)(FiatScreenContent, { setScreen, tokenAmount: deferredTokenAmount, toChain, toToken, selectedCurrency, client, isEmbed: props.isEmbed, onDone, payOptions, theme: props.theme, showCurrencySelector: () => {
    setScreen({
      id: "select-currency",
      backScreen: screen
    });
  }, payer, setTokenAmount, setHasEditedAmount }), screen.id === "select-from-token" && supportedSourcesQuery.data && sourceSupportedTokens && (0, import_jsx_runtime114.jsx)(TokenSelectorScreen, { fiatSupported: props.payOptions.buyWithFiat !== false, client: props.client, sourceTokens: sourceSupportedTokens, sourceSupportedTokens, toChain, toToken, tokenAmount, mode: payOptions.mode, hiddenWallets: props.hiddenWallets, onConnect: () => {
    setScreen({
...
function SelectedTokenInfo(props) {
  ...
  return (0, import_jsx_runtime114.jsx)("div", { children: (0, import_jsx_runtime114.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime114.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime114.jsx)(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", tabIndex: -1, placeholder: "0", type: "text", "data-placeholder": props.tokenAmount === "", value: props.tokenAmount || "0", disabled: props.disabled, onClick: (e) => {
    ...
    textAlign: "left",
    width: getWidth()
  } }), (0, import_jsx_runtime114.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime114.jsx)(TokenSymbol, { token: props.selectedToken, chain: props.selectedChain, size: "md", color: "secondaryText" }), (0, import_jsx_runtime114.jsx)(PayTokenIcon, { chain: props.selectedChain, client: props.client, size: "sm", token: props.selectedToken })] }), (0, import_jsx_runtime114.jsx)(FiatValue, { chain: props.selectedChain, client: props.client, tokenAmount: props.tokenAmount, token: props.selectedToken, size: "sm" })] }), (0, import_jsx_runtime114.jsx)(ChainName, { chain: props.selectedChain, client: props.client, size: "sm", short: true })] }) });
}
function MainScreen(props) {
  ...
  switch (payOptions.mode) {
    case "transaction": {
      return (0, import_jsx_runtime114.jsx)(TransactionModeScreen, { supportedDestinations, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, client, onContinue: (tokenAmount2, toChain2, toToken2) => {
    ...
    case "direct_payment": {
      return (0, import_jsx_runtime114.jsx)(DirectPaymentModeScreen, { client, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, supportedDestinations, onContinue: (tokenAmount2, toChain2, toToken2) => {
        setTokenAmount(tokenAmount2);
        setToChain(toChain2);
        setFromChain(toChain2);
        setFromToken(toToken2);
    ...
    default: {
      return (0, import_jsx_runtime114.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime114.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime114.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime114.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime114.jsx)(BuyTokenInput, { value: tokenAmount, onChange: async (value) => {
        props.setHasEditedAmount(true);
        setTokenAmount(value);
      }, freezeAmount: ((_b = (_a = payOptions.prefillBuy) == null ? void 0 : _a.allowEdits) == null ? void 0 : _b.amount) === false, freezeChainAndToken: ((_d = (_c = payOptions.prefillBuy) == null ? void 0 : _c.allowEdits) == null ? void 0 : _d.chain) === false && ((_f = (_e = payOptions.prefillBuy) == null ? void 0 : _e.allowEdits) == null ? void 0 : _f.token) === false || payOptions.buyWithCrypto !== false && ((_i = (_h = (_g = payOptions.buyWithCrypto) == null ? void 0 : _g.prefillSource) == null ? void 0 : _h.allowEdits) == null ? void 0 : _i.token) === false && ((_l = (_k = (_j = payOptions.buyWithCrypto) == null ? void 0 : _j.prefillSource) == null ? void 0 : _k.allowEdits) == null ? void 0 : _l.chain) === false, token: toToken, chain: toChain, onSelectToken: props.onSelectBuyToken, client: props.client }), (0, import_jsx_runtime114.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime114.jsx)(Container, { flex: "column", gap: "sm", children: !payerAccount ? (0, import_jsx_runtime114.jsx)("div", { children: (0, import_jsx_runtime114.jsx)(ConnectButton, { ...props.connectOptions, client: props.client, theme: props.theme, connectButton: {
        style: {
          width: "100%"
        }
      } }) }) : (0, import_jsx_runtime114.jsx)(Button, { variant: "accent", fullWidth: true, disabled: disableContinue, "data-disabled": disableContinue, onClick: () => {
        if (buyWithFiatEnabled && !buyWithCryptoEnabled) {
          props.setScreen({ id: "buy-with-fiat" });
        } else {
          props.setScreen({
      ...
      }, children: "Continue" }) }), (0, import_jsx_runtime114.jsx)(Spacer, { y: "lg" }), payOptions.showThirdwebBranding !== false && (0, import_jsx_runtime114.jsxs)(import_jsx_runtime114.Fragment, { children: [(0, import_jsx_runtime114.jsx)(PoweredByThirdweb, { link: "https://playground.thirdweb.com/connect/pay?utm_source=ub_text" }), (0, import_jsx_runtime114.jsx)(Spacer, { y: "sm" })] })] });
    }
  }
}
function TokenSelectedLayout(props) {
  return (0, import_jsx_runtime114.jsxs)(Container, { children: [(0, import_jsx_runtime114.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime114.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime114.jsxs)(Container, { px: "lg", style: {
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime114.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime114.jsx)(SelectedTokenInfo, { selectedToken: props.selectedToken, selectedChain: props.selectedChain, tokenAmount: props.tokenAmount, setTokenAmount: props.setTokenAmount, client: props.client, disabled: props.disabled }), (0, import_jsx_runtime114.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime114.jsx)(Line, {}), (0, import_jsx_runtime114.jsx)(Spacer, { y: "sm" }), props.children] })] });
}
...
function ChainSelectionScreen(props) {
  return (0, import_jsx_runtime114.jsx)(NetworkSelectorContent, { client: props.client, connectLocale: props.connectLocale, showTabs: false, onBack: props.goBack, chains: props.chains, closeModal: props.goBack, networkSelector: {
    renderChain(renderChainProps) {
      return (0, import_jsx_runtime114.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
...
//# sourceMappingURL=chunk-MV45MBGF.js.map
