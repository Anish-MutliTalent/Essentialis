...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-XEOW26HF.js");
...
function smartWallet(createOptions) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-AVKCTTUH.js");
    ...
    connect: async (options) => {
      const { connectSmartAccount } = await import("./smart-AVKCTTUH.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-AVKCTTUH.js");
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-RGDHM2SW.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-RGDHM2SW.js");
      const provider = await args.providerFactory();
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
          const { injectedProvider } = await import("./mipdStore-YPIYZL6V.js");
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectEip1193Wallet } = await import("./injected-KZTBHQE2.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-WWAKQY7B.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-WWAKQY7B.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet } = await import("./injected-KZTBHQE2.js");
...
//# sourceMappingURL=chunk-22KSTWL6.js.map
