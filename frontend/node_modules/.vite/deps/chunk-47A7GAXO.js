...
import {
  parseTypedData,
  trackTransaction
} from "./chunk-TBJ4CRRA.js";
import {
  populateEip712Transaction,
  signEip712Transaction
} from "./chunk-2GFN4PVI.js";
import {
  toBigInt
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-TLP3JT4R.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-TLP3JT4R.js");
...
//# sourceMappingURL=chunk-47A7GAXO.js.map
