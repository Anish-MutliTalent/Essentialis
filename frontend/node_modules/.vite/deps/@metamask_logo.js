...
// node_modules/@metamask/logo/data/fox.json
var require_fox = __commonJS({
  "node_modules/@metamask/logo/data/fox.json"(exports, module) {
    module.exports = {
      positions: [
...
// node_modules/@metamask/logo/src/util.js
var require_util = __commonJS({
  "node_modules/@metamask/logo/src/util.js"(exports, module) {
    var perspective = require_perspective();
    var multiply = require_multiply();
    var lookAt = require_lookAt();
    var invert = require_invert();
    var rotate = require_rotate();
    var transform = require_transformMat4();
    var SVG_NS = "http://www.w3.org/2000/svg";
    var defaultCameraDistance = 400;
    var replaceChildrenPonyfill = function(...addNodes) {
    ...
    function createLogoViewer(container, renderScene, {
      ...
      function setLookAtTarget(target) {
        ...
        mouse.x = 1 - 2 * (target.x - bounds.left) / bounds.width;
        mouse.y = 1 - 2 * (target.y - bounds.top) / bounds.height;
      }
    ...
    function createModelRenderer(container, cameraDistance, modelObj, { verticalFieldOfView, near, far }) {
      ...
      return (rect) => {
        ...
        for (i = 0; i < polygons.length; ++i) {
          ...
          for (let j = 0; j < 3; ++j) {
            const idx = indices[j];
            points.push(
              `${0.5 * w * (1 - transformed[3 * idx])},${0.5 * h * (1 - transformed[3 * idx + 1])}`
            );
    ...
    function setGradientDefinitions(container, gradients) {
      ...
      for (const [gradientId, gradientDefinition] of Object.entries(gradients)) {
        ...
        if (gradientDefinition.type === "linear") {
          ...
          if (unsupportedLinearAttribute) {
          ...
          } else if (linearCoordinateAttributes.some(
            (attributeName) => gradientDefinition[attributeName] !== void 0
          )) {
            ...
            for (const attribute of linearCoordinateAttributes) {
              if (typeof gradientDefinition[attribute] !== "string") {
                throw new Error(
                  `Type of '${attribute}' option expected to be 'string'. Instead received type '${typeof gradientDefinition[attribute]}'`
                );
              }
        ...
        if (gradientDefinition.gradientUnits !== void 0) {
          if (!["userSpaceOnUse", "objectBoundingBox"].includes(
        ...
        if (gradientDefinition.gradientTransform !== void 0) {
        ...
        if (gradientDefinition.spreadMethod !== void 0) {
        ...
        if (gradientDefinition.stops !== void 0) {
          ...
          for (const stopDefinition of gradientDefinition.stops) {
            ...
            if (stopDefinition.offset !== void 0) {
              setAttribute(stop, "offset", stopDefinition.offset);
            }
            if (stopDefinition["stop-color"] !== void 0) {
              setAttribute(stop, "stop-color", stopDefinition["stop-color"]);
            }
            if (stopDefinition["stop-opacity"] !== void 0) {
...
// node_modules/@metamask/logo/src/index.js
var require_src = __commonJS({
  "node_modules/@metamask/logo/src/index.js"(exports, module) {
    var foxJson = require_fox();
    var {
      calculateSizingOptions,
      createLogoViewer,
      defaultCameraDistance,
...
//# sourceMappingURL=@metamask_logo.js.map
